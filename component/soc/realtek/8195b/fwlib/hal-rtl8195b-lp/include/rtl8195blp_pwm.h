...
#ifndef _RTL8195BLP_PWM_H_
#define _RTL8195BLP_PWM_H_
...
#include "rtl8195blp_pwm_comm_type.h"
#include "rtl8195blp_pwm_type.h"

/**
 * @addtogroup ls_hal_pwm PWM
 * @{
 */
...
typedef struct hal_pwm_func_stubs_s {
    ...
    HAL_Status (*hal_pwm_init) (hal_pwm_adapter_t *ppwm_adp, u8 pwm_id, pin_sel_t pin_sel,  u16 duty_res_us);
...
/**
 * @addtogroup ls_hal_pwm_rom_func PWM HAL ROM APIs.
 * @{
 */
 ...
 */
__STATIC_INLINE
u32 hal_pwm_comm_enable_sts_rtl8195blp (hal_pwm_comm_adapter_t *ppwm_com_adp)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_update_ctrl_rtl8195blp (hal_pwm_adapter_t *ppwm_adp)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_duty_size_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u32 duty_ticks)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_onduty_start_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u32 start_ticks)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_period_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u32 period_ticks)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_pause_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, BOOL pause_ctrl)
{
 ...
 */
__STATIC_INLINE
u8 hal_pwm_get_run_sts_rtl8195blp (hal_pwm_adapter_t *ppwm_adp)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_period_ie_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, BOOL int_en)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_max_duty_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u32 max_duty_tick)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_min_duty_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u32 min_duty_tick)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_duty_inc_step_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u32 inc_step_ticks)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_duty_dec_step_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u32 dec_step_ticks)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_duty_adj_cycle_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u32 cycle_cnt)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_duty_adj_en_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, BOOLEAN enable)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_duty_adj_dir_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, pwm_duty_adj_dir_t dir)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_duty_loop_mode_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u8 loop_en)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_max_duty_int_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u8 int_en)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_min_duty_int_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u8 int_en)
{
    ppwm_adp->base_addr->auto_adj_ctrl_b.duty_dn_lim_ie = int_en;
}

void hal_pwm_comm_irq_reg_rtl8195blp (irq_handler_t irq_handler);
void hal_pwm_comm_irq_unreg_rtl8195blp (void);
void hal_pwm_limirq_reg_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, pwm_lim_callback_t callback, void *phid);
void hal_pwm_limirq_unreg_rtl8195blp (hal_pwm_adapter_t *ppwm_adp);
void hal_pwm_comm_init_rtl8195blp (hal_pwm_comm_adapter_t *ppwm_com_adp);
void hal_pwm_comm_deinit_rtl8195blp (void);
void hal_pwm_comm_tick_source_list_rtl8195blp (uint8_t *timer_list);
hal_status_t hal_pwm_init_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u8 pwm_id, pin_sel_t pin_sel, u16 duty_res_us);
BOOLEAN hal_pwm_enable_sts_rtl8195blp (hal_pwm_adapter_t *ppwm_adp);
void hal_pwm_comm_enable_rtl8195blp (u32 en_ctrl);
void hal_pwm_comm_disable_rtl8195blp (u32 dis_ctrl);
void hal_pwm_enable_rtl8195blp (hal_pwm_adapter_t *ppwm_adp);
void hal_pwm_disable_rtl8195blp (hal_pwm_adapter_t *ppwm_adp);
void hal_pwm_deinit_rtl8195blp (hal_pwm_adapter_t *ppwm_adp);
void hal_pwm_set_clk_sel_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, pwm_clk_sel_t clk_sel);
void hal_pwm_wait_ctrl_ready_rtl8195blp (hal_pwm_adapter_t *ppwm_adp);
hal_status_t hal_pwm_set_tick_time_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u32 tick_p5us);
hal_status_t hal_pwm_set_duty_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u32 period_us,
                                            u32 duty_us, u32 start_offset_us);
u32 hal_pwm_read_duty_rtl8195blp (hal_pwm_adapter_t *ppwm_adp);
void hal_pwm_change_duty_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u32 duty_us);
hal_status_t hal_pwm_set_duty_limit_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u32 max_duty_us, u32 min_duty_us);
void hal_pwm_set_auto_duty_adj_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, hal_pwm_auto_duty_adj_t *pauto_duty);
void hal_pwm_auto_duty_en_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, BOOLEAN enable);
hal_status_t hal_pwm_set_auto_duty_inc_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u32 max_duty_us,
                                                u32 step_sz_us, u32 step_period_cnt);
hal_status_t hal_pwm_set_auto_duty_dec_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u32 min_duty_us,
                                                u32 step_sz_us, u32 step_period_cnt);
hal_status_t hal_pwm_set_auto_duty_loop_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u8 ini_dir, u32 loop_cnt);
void hal_pwm_set_period_int_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, pwm_period_callback_t callback, \
                                        void *arg, u8 int_en);
void hal_pwm_set_autoadj_int_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, pwm_lim_callback_t callback, \
                                        void *arg, u8 int_en);
void hal_pwm_set_autoadj_loop_int_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, pwm_lo_callback_t callback, void *arg);

hal_status_t hal_pwm_auto_duty_inc_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u32 max_duty_us,
                                                u32 step_sz_us, u32 step_period_cnt);
hal_status_t hal_pwm_auto_duty_dec_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u32 min_duty_us,
                                                u32 step_sz_us, u32 step_period_cnt);
hal_status_t hal_pwm_auto_duty_loop_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u32 ini_duty_us, u8 ini_dir, u32 loop_cnt);
void hal_pwm_stop_duty_loop_rtl8195blp (hal_pwm_adapter_t *ppwm_adp, u8 stop_now);

/** @} */ /* End of group ls_hal_pwm_rom_func */
...
/** @} */ /* End of group ls_hal_pwm */

#endif  // end of "#define _RTL8195BLP_PWM_H_"
