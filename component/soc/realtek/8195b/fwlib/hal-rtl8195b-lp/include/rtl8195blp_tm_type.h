...
#ifndef _RTL8195BLP_TM_TYPE_H_
#define _RTL8195BLP_TM_TYPE_H_
...
/**
 * @addtogroup ls_hal_tm_reg TM Registers.
 * @ingroup ls_hal_timer
 * @{
 */
...
#endif    // end of #ifndef _RTL8195BLP_TM_TYPE_H_
