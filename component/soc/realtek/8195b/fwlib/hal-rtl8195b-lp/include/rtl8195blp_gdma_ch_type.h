/**************************************************************************//**
 * @file     rtl8195blp_gdma_ch_type.h
 * @brief    Define GDMA channel register struct for local use.
 * @version  1.00
 * @date     2017-08-22
 *
 * @note
...
#ifndef _RTL8195BLP_CH_TYPE_H_
#define _RTL8195BLP_CH_TYPE_H_
...
/**
 * @addtogroup ls_hal_gdma_ch_reg GDMA Channel Registers.
 * @ingroup ls_hal_gdma_reg
 * @{
 */


/**
  \brief Union type to access ch_sar (@ 0x00000000).
*/
typedef union {
...
/**
  \brief Union type to access ch_dar (@ 0x00000008).
*/
typedef union {
...
/**
  \brief Union type to access ch_ctl_low (@ 0x00000018).
*/
typedef union {
...
} ch_ctl_low_t, *pch_ctl_low_t;

/**
  \brief Union type to access ch_ctl_up (@ 0x0000001C).
*/
typedef union {
...
} ch_ctl_up_t, *pch_ctl_up_t;

/**
  \brief Union type to access ch_cfg_low (@ 0x00000040).
*/
typedef union {
...
} ch_cfg_low_t, *pch_cfg_low_t;

/**
  \brief Union type to access ch_cfg_up (@ 0x00000044).
*/
typedef union {
...
} ch_cfg_up_t, *pch_cfg_up_t;

#ifdef  __cplusplus
}
#endif

#endif    // end of #ifndef _RTL8195BLP_CH_TYPE_H_
