...
#ifndef _RTL8195BLP_PWM_TYPE_H_
#define _RTL8195BLP_PWM_TYPE_H_
...
/**
 * @addtogroup ls_hal_pwm_reg PWM Registers.
 * @ingroup ls_hal_pwm
 * @{
 */
...
#endif    // end of #ifndef _RTL8195BLP_PWM_TYPE_H_
