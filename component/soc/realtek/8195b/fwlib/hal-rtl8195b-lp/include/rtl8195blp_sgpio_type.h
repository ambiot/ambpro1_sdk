...
#ifndef _RTL8195BLP_SGPIO_TYPE_H_
#define _RTL8195BLP_SGPIO_TYPE_H_
...
/**
 * @addtogroup ls_hal_sgpio_reg SGPIO Registers.
 * @ingroup ls_hal_sgpio
 * @{
 */
...
#endif    // end of #ifndef _RTL8195BLP_SGPIO_TYPE_H_
