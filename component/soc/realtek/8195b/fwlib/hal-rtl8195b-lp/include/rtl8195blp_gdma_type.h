/**************************************************************************//**
 * @file      rtl8195blp_gdma_type.h
 * @brief    Define GDMA common register struct for local use.
 * @version   V1.00
...
#ifndef _RTL8195BLP_GDMA_TYPE_H_
#define _RTL8195BLP_GDMA_TYPE_H_
...
/**
 * @addtogroup ls_hal_gdma_reg GDMA Registers.
 * @ingroup ls_hal_gdma
 * @{
 */

/**
 * @addtogroup ls_hal_gdma_com_reg GDMA Common Registers.
...
/** @} */ /* End of group ls_hal_gdma_com_reg */
...
#endif    // end of #ifndef _RTL8195BLP_GDMA_TYPE_H_
