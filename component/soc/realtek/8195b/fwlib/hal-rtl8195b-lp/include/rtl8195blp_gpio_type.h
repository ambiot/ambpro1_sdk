...
#ifndef _RTL8195BLP_GPIO_TYPE_H_
#define _RTL8195BLP_GPIO_TYPE_H_
...
/**
 * @addtogroup ls_hal_gpio_reg GPIO Registers.
 * @ingroup ls_hal_gpio
 * @{
 */
...
#endif    // end of #ifndef _RTL8195BLP_GPIO_TYPE_H_
