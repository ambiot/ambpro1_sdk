/**************************************************************************//**
 * @file      rtl8195blp_spic_type.h
 * @brief    Define SPIC register struct for local use.
 * @version   V1.00
...
#ifndef _RTL8195BLP_SPIC_TYPE_H_
#define _RTL8195BLP_SPIC_TYPE_H_
...
/**
 * @addtogroup ls_hal_spic_reg Flash Controller Registers.
 * @ingroup ls_hal_spic
 * @{
 */
...
/**
  \brief Union type to access spic_spic_imr (@ 0x0000002C).
*/
typedef union {
  ...
  } b;                                        /*!< bit fields for spic_spic_imr */
} spic_spic_imr_t, *pspic_spic_imr_t;

/**
  \brief Union type to access spic_spic_isr (@ 0x00000030).
*/
typedef union {
  ...
  struct {
    ...
    __IM  uint32_t rxsis      : 1;            /*!< [10..10] Receive Split Interrupt Status after Masking. 0 : spi_rx_sir_r
                                                   ...
                                                   interrupt is active after masking                                         */
  } b;                                        /*!< bit fields for spic_spic_isr */
} spic_spic_isr_t, *pspic_spic_isr_t;

/**
  \brief Union type to access spic_spic_risr (@ 0x00000034).
*/
typedef union {
  ...
  } b;                                        /*!< bit fields for spic_spic_risr */
} spic_spic_risr_t, *pspic_spic_risr_t;
...
#endif    // end of #ifndef _RTL8195BLP_SPIC_TYPE_H_
