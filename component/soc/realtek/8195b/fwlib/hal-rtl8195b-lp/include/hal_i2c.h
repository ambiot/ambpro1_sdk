 ...
 * @ingroup 8195bl_hal
 * @{
 * @brief The I2C HAL module of the LS platform.
 */
 ...
 */
__STATIC_INLINE uint8_t hal_i2c_read_dat_reg (hal_i2c_adapter_t *phal_i2c_adapter)
{
 ...
 */
__STATIC_INLINE uint32_t hal_i2c_get_rx_flr (hal_i2c_adapter_t *phal_i2c_adapter)
{
 ...
 */
__STATIC_INLINE uint32_t hal_i2c_get_tx_flr (hal_i2c_adapter_t *phal_i2c_adapter)
{
 ...
 *   \return void
 */
__STATIC_INLINE void hal_i2c_slv_set_for_mst_rd_cmd (hal_i2c_adapter_t *phal_i2c_adapter)
{
 ...
 *   \return void
 */
__STATIC_INLINE void hal_i2c_slv_clear_for_mst_rd_cmd (hal_i2c_adapter_t *phal_i2c_adapter)
{
 ...
 *   \return void
 */
__STATIC_INLINE void hal_i2c_mst_addr_retry_ctrl (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t retry_en)
{
    if (retry_en) {
 ...
 *   \return void
 */
__STATIC_INLINE void hal_i2c_mst_restr_sw_ctrl (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t restr_en)
{
    if (restr_en) {
 ...
 *   \return void
 */
__STATIC_INLINE void hal_i2c_set_slv_ack_addr (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t addr_idx, uint32_t ack_addr)
{
    if (!addr_idx) {
