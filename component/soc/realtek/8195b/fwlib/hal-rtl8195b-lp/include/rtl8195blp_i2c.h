/**************************************************************************//**
 * @file     rtl819blp_i2c.h
 * @brief    The fundamental definition for RTL8195B LP i2C module.
 * @version  V1.00
 * @date     2016-07-15
 *
 * @note
...
#ifndef _RTL8195BLP_I2C_H_
#define _RTL8195BLP_I2C_H_

#include "rtl8195blp_i2c_type.h"
...
#define LP_I2C_NO               1
/// i2c IRQ Priority
#define LP_I2C_IRQ_PR           3
/// i2c address retry time-out
#define LP_I2C_ATRY_TO          3000
/// i2c master mode address retry function
#define LP_I2C_ADD_RETRY        1
/// i2c master mode address retry max count
#define LP_I2C_ADD_RTY_MAX      256
/// i2c default DMA TX src width
#define LP_I2C_DMA_DEFAULT_TX_SRC_WIDTH     4
/// i2c default DMA RX des width
#define LP_I2C_DMA_DEFAULT_RX_DES_WIDTH     4
#undef LP_I2C_DMA_MULTI_BLOCK       //lp i2c DMA with multi-block feature, only available in hp domain
/// i2c timeout check feature disabled
#define LP_I2C_TIMEOUT_DISABLE  0x00
/// i2c timeout in endless time
#define LP_I2C_TIMEOUT_ENDLESS  0xFFFFFFFF
/// i2c TX-FIFO depth
#define LP_I2C_TX_FIFO_DEPTH    16
/// i2c RX-FIFO depth
#define LP_I2C_RX_FIFO_DEPTH    16
/// i2c filter cap. low length
#define LP_I2C_FLTR_CAP_L_LEN   20
/// i2c filter cap. main length
#define LP_I2C_FLTR_CAP_M_LEN   5
/// i2c filter resis. low length
#define LP_I2C_FLTR_RSTS_L_LEN  20
/// i2c filter resis. low length
#define LP_I2C_FLTR_RSTS_M_LEN  20
...
/**
  \brief  Type to access RTL8195B LP I2C function control register.
 */
typedef union {
...
} lp_i2c_func_ctrl_t, *plp_i2c_func_ctrl_t;

#define LP_I2C_FUNC_CLK_CTRL_REG        ((lp_i2c_func_ctrl_t *) (KM0_SYSON_BASE + 0x19CUL))
...
typedef struct i2c_init_dat_s {
    ...
    I2C_Type    *reg_base;                      /*!< Offset: 0x018   i2c register base address  */
...
/** \brief i2c pin definition structure
*/
typedef struct hal_i2c_pin_s {
    uint8_t sda;                    /*! i2c data pin    */
    uint8_t scl;                    /*! i2c clock pin    */
    uint8_t eol;
 ...
 *
 *   \param uint32_t reg:       register offset
 *   \param uint32_t val:       register value
 */
__STATIC_INLINE void hal_i2c_write32(uint32_t reg, uint32_t val)
{
    HAL_WRITE32(I2C_BASE, reg, val);
}
 ...
 */
__STATIC_INLINE uint32_t hal_i2c_read32(uint32_t reg)
{
    return (uint32_t)(HAL_READ32(I2C_BASE, reg));
}

/** \brief Description of hal_i2c_idx_chk_rtl8195blp
 *
 *    hal_i2c_idx_chk_rtl8195b is used for checking i2c module is available or not
 *
 *   \param idx:     I2C index
 *   \return HAL_Status.
 */
__STATIC_INLINE hal_status_t hal_i2c_idx_chk_rtl8195blp (uint8_t idx)
{
    if (idx > LP_I2C_NO)
...
/** \brief Description of hal_i2c_slv_set_for_mst_rd_cmd_rtl8195blp
 *
 *    hal_i2c_slv_set_for_mst_rd_cmd_rtl8195blp is to set interrupt mask for Read Request interrupt which is from
 *    other masters.
 *
 *   \param hal_i2c_adapter_t *phal_i2c_adapter:   pointer to I2C control adapter.
 *   \return void
 */
__STATIC_INLINE void hal_i2c_slv_set_for_mst_rd_cmd_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter)
{
...
/** \brief Description of hal_i2c_slv_set_for_mst_rd_cmd_rtl8195blp
 *
 *    hal_i2c_slv_set_for_mst_rd_cmd_rtl8195blp is to clear interrupt mask for Read Request interrupt which is from
 *    other masters.
 *
 *   \param hal_i2c_adapter_t *phal_i2c_adapter:   pointer to I2C control adapter.
 *   \return void
 */
__STATIC_INLINE void hal_i2c_slv_clear_for_mst_rd_cmd_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter)
{
 ...
 *  @{
 */
#define HAL_I2C_WRITE32(addr, value)    hal_i2c_write32((uint32_t)addr,value)
#define HAL_I2C_READ32(addr)            hal_i2c_read32((uint32_t)addr)
#define READ_CLEAR_I2C_REG(base, reg_name)   base->reg_name
#define I2C_BASE_REG        ((I2C_Type *) 0)
/** @} */ // end of I2C REG ACCESS MACRO


uint8_t hal_i2c_timeout_chk_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter, uint32_t start_cnt);
void hal_i2c_dma_irq_handler_rtl8195blp (void);
void hal_i2c_mst_irq_handler_rtl8195blp (void);
void hal_i2c_slv_irq_handler_rtl8195blp (void);
uint8_t hal_i2c_chk_mod_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
uint8_t hal_i2c_pure_init_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
uint8_t hal_i2c_pure_deinit_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
uint8_t hal_i2c_en_ctrl_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t enable);
hal_status_t hal_i2c_set_clk_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_intr_ctrl_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t set_clr, uint16_t intr_msk);
hal_status_t hal_i2c_wr_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter, const uint8_t *dat_buf, uint32_t dat_len, uint8_t ctrl);
void hal_i2c_mst_send_rdcmd_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter, uint32_t cmd_len, uint8_t ctrl);
uint32_t hal_i2c_dma_ctrl_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t enable);
hal_status_t hal_i2c_mst_restr_ctrl_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t restr_en);
hal_status_t hal_i2c_mst_gc_sb_ctrl_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t enable, uint8_t gc_sb);
hal_status_t hal_i2c_slv_no_ack_ctrl_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t no_ack_en);
uint8_t hal_i2c_slv_no_ack_sts_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_slv_ack_gc_ctrl_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t slv_gc_en);
uint8_t hal_i2c_slv_ack_gc_sts_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_slv_to_slp_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
uint8_t hal_i2c_slv_chk_mst_wr_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
uint8_t hal_i2c_slv_chk_rd_req_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_pin_init_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_pin_deinit_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
void hal_i2c_reg_irq_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter, irq_handler_t handler);
void hal_i2c_unreg_irq_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_init_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_deinit_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_load_default_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t index);
hal_status_t hal_i2c_set_tar_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t mst_rw);
hal_status_t hal_i2c_send_addr_retry_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_send_poll_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_send_intr_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_send_dma_init_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter, hal_gdma_adaptor_t *padc_gdma_tx_adaptor);
hal_status_t hal_i2c_send_dma_deinit_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_send_dma_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_send_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_recv_addr_retry_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_recv_poll_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_recv_intr_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_recv_dma_init_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter, hal_gdma_adaptor_t *padc_gdma_rx_adaptor);
hal_status_t hal_i2c_recv_dma_deinit_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_recv_dma_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_receive_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_set_sar_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t sar_idx, uint16_t slv_addr);
uint32_t hal_i2c_slv_recv_poll_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
uint32_t hal_i2c_slv_recv_intr_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
uint32_t hal_i2c_slv_recv_dma_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_slv_recv_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
uint32_t hal_i2c_slv_send_poll_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
uint32_t hal_i2c_slv_send_intr_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
uint32_t hal_i2c_slv_send_dma_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_slv_send_rtl8195blp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_init_rtl8195blp_patch (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_deinit_rtl8195blp_path (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_mst_restr_ctrl_rtl8195blp_patch (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t restr_en);
hal_status_t hal_i2c_mst_gc_sb_ctrl_rtl8195blp_patch (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t enable, uint8_t gc_sb);
void hal_i2c_slv_irq_handler_rtl8195blp_patch (void *data);
...
typedef struct hal_i2c_func_stubs_s {
        ...
        void (*hal_i2c_dma_irq_handler) (void);
        void (*hal_i2c_mst_irq_handler) (void);
        void (*hal_i2c_slv_irq_handler) (void);
        const hal_i2c_pin_t *hal_i2c_pin_list;
        volatile hal_i2c_adapter_t **phal_i2c_irq_adpt;
