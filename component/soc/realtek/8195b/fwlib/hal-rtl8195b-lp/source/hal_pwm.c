...
hal_status_t hal_pwm_set_duty_rtl8195blp_patch (hal_pwm_adapter_t *ppwm_adp, u32 period_us,
                                            u32 duty_us, u32 start_offset_us);
void hal_pwm_deinit_rtl8195blp_patch (hal_pwm_adapter_t *ppwm_adp);
#endif
...
void hal_pwm_deinit (hal_pwm_adapter_t *ppwm_adp)
{
        ...
        hal_pwm_deinit_rtl8195blp_patch(ppwm_adp);
    #else
...
{
#if (CHIP_VER == CHIP_A_CUT) && (defined(CONFIG_BUILD_RAM))
    return  hal_pwm_set_duty_rtl8195blp_patch (ppwm_adp, period_us, duty_us, start_offset_us);
#else
