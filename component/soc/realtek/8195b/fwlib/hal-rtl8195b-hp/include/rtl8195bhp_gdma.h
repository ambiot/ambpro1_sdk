...
#ifndef RTL8195BHP_GDMA_H
#define RTL8195BHP_GDMA_H
...
#define GDMA_HANDSHAKE_SSI0_TX              6   //!< Define GDMA hardware handshake number for SSI0 TX
#define GDMA_HANDSHAKE_SSI0_RX              7   //!< Define GDMA hardware handshake number for SSI0 RX
#define GDMA_HANDSHAKE_SSI2_TX              8   //!< Define GDMA hardware handshake number for SSI2 TX
#define GDMA_HANDSHAKE_SSI2_RX              9   //!< Define GDMA hardware handshake number for SSI2 RX
#define GDMA_HANDSHAKE_SSI3_TX              10  //!< Define GDMA hardware handshake number for SSI3 TX
#define GDMA_HANDSHAKE_SSI3_RX              11  //!< Define GDMA hardware handshake number for SSI3 RX
...
#define GDMA_HANDSHAKE_SGPIO0_TX            18  //!< Define GDMA hardware handshake number for SGPIO0 TX
#define GDMA_HANDSHAKE_HS_SSI0_TX           19  //!< Define GDMA hardware handshake number for HS_SSI0(SPI1) TX
#define GDMA_HANDSHAKE_HS_SSI0_RX           20  //!< Define GDMA hardware handshake number for HS_SSI0(SPI1) RX
#define GDMA_HANDSHAKE_CODEC_TX             21  //!< Define GDMA hardware handshake number for CODEC TX
#define GDMA_HANDSHAKE_CODEC_RX             22  //!< Define GDMA hardware handshake number for CODEC RX
#define GDMA_HANDSHAKE_ADC                  23  //!< Define GDMA hardware handshake number for ADC TX
#define GDMA_HANDSHAKE_FLASH_TX             24  //!< Define GDMA hardware handshake number for FLASH TX
#define GDMA_HANDSHAKE_FLASH_RX             25  //!< Define GDMA hardware handshake number for FLASH RX
#define GDMA_HANDSHAKE_TFT_TX               26  //!< Define GDMA hardware handshake number for TFT TX
#define GDMA_HANDSHAKE_TFT_RX               27  //!< Define GDMA hardware handshake number for TFT RX
#define GDMA_HANDSHAKE_SGPIO1_TX            28  //!< Define GDMA hardware handshake number for SGPIO1 TX
#define GDMA_HANDSHAKE_SGPIO2_TX            29  //!< Define GDMA hardware handshake number for SGPIO2 TX
...
typedef struct _hal_gdma_adaptor_s {
    ...
    u32                         block_num;                                                      //!<  Record block numbers for non-sequential linked list block transfer
...
typedef struct _hal_gdma_group_s {
    ...
    u8 chnl_in_use[MAX_GDMA_INDX+1];                                            //!<  Record which channel is used, it is stored separately under secure and non-secure mode
#if !defined (CONFIG_BUILD_NONSECURE)
    u8 hal_gdma_reg[MAX_GDMA_INDX+1];                                           //!<  Record which channel is used and registered. Globally managed under secure mode.
#endif
...
void hal_gdma_on_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor);
void hal_gdma_off_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor);
void hal_gdma_chnl_en_rtl8195bhp (phal_gdma_adaptor_t phal_gdma_adaptor);
void hal_gdma_chnl_dis_rtl8195bhp (phal_gdma_adaptor_t phal_gdma_adaptor);
void hal_gdma_isr_en_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor);
void hal_gdma_isr_dis_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor);
void hal_gdma_clean_pending_isr_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor);
void hal_gdma_clean_chnl_isr_rtl8195bhp (phal_gdma_adaptor_t phal_gdma_adaptor);
void hal_gdma_chnl_clean_auto_src_rtl8195bhp (phal_gdma_adaptor_t phal_gdma_adaptor);
void hal_gdma_chnl_clean_auto_dst_rtl8195bhp (phal_gdma_adaptor_t phal_gdma_adaptor);
hal_status_t hal_gdma_chnl_setting_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor);
hal_status_t hal_gdma_chnl_block_setting_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor);
u32 hal_gdma_query_dar_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor);
u32 hal_gdma_query_sar_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor);
BOOL hal_gdma_query_chnl_en_rtl8195bhp (phal_gdma_adaptor_t phal_gdma_adaptor);
u32 hal_gdma_query_send_bytes_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor);
u32 hal_gdma_query_abort_recv_bytes_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor);
u32 hal_gdma_query_recv_bytes_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor);
hal_status_t hal_gdma_chnl_register_rtl8195bhp(u8 gdma_index, u8 chnl_num);
hal_status_t hal_gdma_chnl_unregister_rtl8195bhp (phal_gdma_adaptor_t phal_gdma_adaptor);
hal_status_t hal_gdma_chnl_init_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor);
void hal_gdma_chnl_irq_free_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor);
void hal_gdma_handshake_init_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor, u8 handshake_num);
void hal_gdma_memcpy_irq_hook_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor, gdma_callback_t gdma_cb_func, void *gdma_cb_data);
void hal_gdma_memcpy_irq_handler_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor);
void GDMA0_IRQHandler(void);
void GDMA1_IRQHandler(void);
void hal_gdma_irq_set_priority_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor, u32 irq_priority);
void hal_gdma_irq_reg_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor, irq_handler_t irq_handler, void *irq_data);
void hal_gdma_transfer_start_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor, u8 multi_blk_en);
void hal_gdma_group_init_rtl8195bhp(phal_gdma_group_t pgdma_group);
void hal_gdma_multi_block_init_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor);
hal_status_t hal_gdma_memcpy_config_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor, void *pdest, void *psrc, u32 len);
void hal_gdma_linked_list_block_init_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor, phal_gdma_block_t phal_gdma_block);
hal_status_t hal_gdma_linked_list_block_config_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor, phal_gdma_block_t phal_gdma_block, u8 block_num);
void hal_gdma_abort_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor);
void hal_gdma_chnl_reset_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor);

#if !defined (CONFIG_BUILD_NONSECURE)
void hal_gdma_chnl_free_rtl8195bhp (phal_gdma_adaptor_t phal_gdma_adaptor);
hal_status_t hal_gdma_chnl_alloc_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor, u8 multi_blk_en);
BOOL hal_gdma_memcpy_init_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor, pgdma_ch_lli_t pgdma_ch_lli);
void hal_gdma_memcpy_deinit_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor);
hal_status_t hal_gdma_memcpy_rtl8195bhp(phal_gdma_adaptor_t phal_gdma_adaptor, void *pdest, void *psrc, u32 len);
#endif
