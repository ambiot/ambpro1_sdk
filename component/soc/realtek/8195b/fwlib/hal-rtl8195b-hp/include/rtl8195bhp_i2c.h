...
#ifndef _RTL8195BHP_I2C_H_
#define _RTL8195BHP_I2C_H_

#include "rtl8195bhp_i2c_type.h"
...
#define HP_I2C_FUNC_CLK_CTRL_REG        ((hp_i2c_func_ctrl_t *) (TM9_SYSON_BASE + 0x264UL))
...
/** \brief Description of hal_i2c_idx_chk_rtl8195bhp
 *
 *    hal_i2c_idx_chk_rtl8195bhp is used for checking i2c module is available or not
 *
 *   \param[in] uint8_t idx:     I2C index
 *   \return HAL_Status.
 */
static inline hal_status_t hal_i2c_idx_chk_rtl8195bhp (uint8_t idx)
{
    if ((idx == 1) || (idx > 3)) {
...
/** \brief Description of hal_i2c_slv_set_for_mst_rd_cmd_rtl8195bhp
 *
 *    hal_i2c_slv_set_for_mst_rd_cmd_rtl8195bhp is to set interrupt mask for Read Request interrupt which is from
 *    other masters.
 *
 *   \param[in] hal_i2c_adapter_t *phal_i2c_adapter:   pointer to I2C control adapter.
 *   \return void
 */
static inline void hal_i2c_slv_set_for_mst_rd_cmd_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter)
{
    phal_i2c_adapter->init_dat.reg_base->intr_msk_b.rd_req = I2CEnable;
}

/** \brief Description of hal_i2c_slv_clear_for_mst_rd_cmd_rtl8195bhp
 *
 *    hal_i2c_slv_clear_for_mst_rd_cmd_rtl8195bhp is to clear interrupt mask for Read Request interrupt which is from
 *    other masters.
 *
 *   \param[in] hal_i2c_adapter_t *phal_i2c_adapter:   pointer to I2C control adapter.
 *   \return void
 */
static inline void hal_i2c_slv_clear_for_mst_rd_cmd_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter)
{
...
uint8_t hal_i2c_timeout_chk_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter, uint32_t start_cnt);
void hal_i2c_dma_irq_handler_rtl8195bhp (void *data);
void hal_i2c_mst_irq_handler_rtl8195bhp (void *data);
void hal_i2c_slv_irq_handler_rtl8195bhp (void *data);
uint8_t hal_i2c_chk_mod_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
uint8_t hal_i2c_pure_init_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
uint8_t hal_i2c_pure_deinit_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
uint8_t hal_i2c_en_ctrl_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t enable);
hal_status_t hal_i2c_set_clk_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_intr_ctrl_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t set_clr, uint16_t intr_msk);
hal_status_t hal_i2c_wr_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter, const uint8_t *dat_buf, uint32_t dat_len, uint8_t ctrl);
void hal_i2c_mst_send_rdcmd_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter, uint32_t cmd_len, uint8_t ctrl);
uint32_t hal_i2c_dma_ctrl_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t enable);
hal_status_t hal_i2c_mst_restr_ctrl_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t restr_en);
hal_status_t hal_i2c_mst_gc_sb_ctrl_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t enable, uint8_t gc_sb);
hal_status_t hal_i2c_slv_no_ack_ctrl_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t no_ack_en);
uint8_t hal_i2c_slv_no_ack_sts_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_slv_ack_gc_ctrl_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t slv_gc_en);
uint8_t hal_i2c_slv_ack_gc_sts_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_slv_to_slp_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
uint8_t hal_i2c_slv_chk_mst_wr_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
uint8_t hal_i2c_slv_chk_rd_req_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_pin_init_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_pin_deinit_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
void hal_i2c_reg_comm_irq_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter, irq_handler_t handler);
void hal_i2c_reg_irq_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter, irq_handler_t handler);
uint8_t hal_i2c_unreg_irq_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_init_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_deinit_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_load_default_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t index);
hal_status_t hal_i2c_set_tar_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t mst_rw);
hal_status_t hal_i2c_send_addr_retry_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_send_poll_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_send_intr_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
//hal_status_t hal_i2c_send_dma_init_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
//hal_status_t hal_i2c_send_dma_deinit_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
//hal_status_t hal_i2c_send_dma_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
//hal_status_t hal_i2c_send_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_recv_addr_retry_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_recv_poll_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_recv_intr_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
//hal_status_t hal_i2c_recv_dma_init_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
//hal_status_t hal_i2c_recv_dma_deinit_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
//hal_status_t hal_i2c_recv_dma_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
//hal_status_t hal_i2c_receive_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
hal_status_t hal_i2c_set_sar_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter, uint8_t sar_idx, uint16_t slv_addr);
uint32_t hal_i2c_slv_recv_poll_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
uint32_t hal_i2c_slv_recv_intr_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
//uint32_t hal_i2c_slv_recv_dma_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
//hal_status_t hal_i2c_slv_recv_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
uint32_t hal_i2c_slv_send_poll_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
uint32_t hal_i2c_slv_send_intr_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
//uint32_t hal_i2c_slv_send_dma_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);
//hal_status_t hal_i2c_slv_send_rtl8195bhp (hal_i2c_adapter_t *phal_i2c_adapter);

/**
  \brief  The data structure of the stubs function for the I2C HAL functions in ROM
*/
typedef struct hal_i2c_func_stubs_s {
        hal_i2c_pin_t *hal_i2c_pin_list;
