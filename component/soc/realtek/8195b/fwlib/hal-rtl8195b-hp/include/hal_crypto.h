...
#define _ERRNO_CRYPTO_CACHE_HANDLE			                    -18
#define _ERRNO_CRYPTO_CIPHER_DECRYPT_MSGLEN_NOT_8Byte_Aligned	-19

void NS_ENTRY rtl_cryptoEngine_init_platform_nsc(const int en);
 ...
 *  @return      value < 0      fail(Refer to ERRNO)
 */
int rtl_crypto_sha2_224(IN const u8 *message, IN const u32 msglen, OUT u8 *pDigest);
 ...
 *  @return      value < 0      fail(Refer to ERRNO)
 */
int rtl_crypto_sha2_224_update(IN const u8 *message, IN const u32 msglen);
 ...
 *  @return      value < 0      fail(Refer to ERRNO)
 */
int rtl_crypto_sha2_256(IN const u8 *message, IN const u32 msglen, OUT u8 *pDigest);
 ...
 *  @return      value < 0      fail(Refer to ERRNO)
 */
int rtl_crypto_sha2_256_update(IN const u8 *message, IN const u32 msglen);
 ...
 *  @return      value < 0      fail(Refer to ERRNO)
 */
int rtl_crypto_hmac_sha2_224( IN const u8 *message, IN const u32 msglen,
            IN const u8 *key, IN const u32 keylen, OUT u8 *pDigest);
 ...
 *  @return      value < 0      fail(Refer to ERRNO)
 */
int rtl_crypto_hmac_sha2_224_process(IN const u8 *message, IN const u32 msglen, OUT u8 *pDigest);
 ...
 *  @return      value < 0      fail(Refer to ERRNO)
 */
int rtl_crypto_hmac_sha2_224_update(IN const u8 *message, IN const u32 msglen);
 ...
 *  @return      value < 0      fail(Refer to ERRNO)
 */
int rtl_crypto_hmac_sha2_256( IN const u8 *message, IN const u32 msglen,
            IN const u8 *key, IN const u32 keylen, OUT u8 *pDigest);
 ...
 *  @return      value < 0      fail(Refer to ERRNO)
 */
int rtl_crypto_hmac_sha2_256_process(IN const u8 *message, IN const u32 msglen, OUT u8 *pDigest);
 ...
 *  @return      value < 0      fail(Refer to ERRNO)
 */
int rtl_crypto_hmac_sha2_256_update(IN const u8 *message, IN const u32 msglen);
 ...
 *  @return      value < 0      fail(Refer to ERRNO)
 */
int rtl_crypto_crc_setting(int order, unsigned long polynom, unsigned long crcinit,
...
int hal_crypto_auth_update_rtl8195bhp_patch(hal_crypto_adapter_t *pcrypto_adapter, IN const u32 auth_type,
                                            IN const u8 *message, IN const u32 msglen);

int hal_crypto_auth_final_rtl8195bhp_patch(hal_crypto_adapter_t *pcrypto_adapter, IN const u32 auth_type, OUT u8 *pDigest);
