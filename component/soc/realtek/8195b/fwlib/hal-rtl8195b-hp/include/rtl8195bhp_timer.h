 ...
 */
__STATIC_INLINE
u8 hal_timer_group_get_ists_rtl8195bhp (hal_timer_group_adapter_t *ptg_adp)
{
 ...
 */
__STATIC_INLINE
u8 hal_timer_group_get_rists_rtl8195bhp (hal_timer_group_adapter_t *ptg_adp)
{
 ...
 */
__STATIC_INLINE
u8 hal_timer_get_int_pending_rtl8195bhp (phal_timer_adapter_t ptimer_adp)
{
 ...
 */
__STATIC_INLINE
u8 hal_timer_get_rint_pending_rtl8195bhp (phal_timer_adapter_t ptimer_adp)
{
 ...
 */
__STATIC_INLINE
void hal_timer_set_reload_rtl8195bhp (phal_timer_adapter_t ptimer_adp, u32 reload)
{
 ...
 */
__STATIC_INLINE
u32 hal_timer_read_rtl8195bhp (phal_timer_adapter_t ptimer_adp)
{
#if 1
    u32 cnt;
 ...
 */
__STATIC_INLINE
void hal_timer_write_rtl8195bhp (phal_timer_adapter_t ptimer_adp, u32 tc)
{
 ...
 */
__STATIC_INLINE
void hal_timer_write_prescal_cnt_rtl8195bhp (phal_timer_adapter_t ptimer_adp, u16 psc)
{
 ...
 */
__STATIC_INLINE
u16 hal_timer_read_prescal_cnt_rtl8195bhp (phal_timer_adapter_t ptimer_adp)
{
 ...
 */
__STATIC_INLINE
void hal_timer_set_prescal_rtl8195bhp (phal_timer_adapter_t ptimer_adp, u16 psrc)
{
 ...
 */
__STATIC_INLINE
void hal_timer_enable_rtl8195bhp (phal_timer_adapter_t ptimer_adp)
{
 ...
 */
__STATIC_INLINE
void hal_timer_disable_rtl8195bhp (phal_timer_adapter_t ptimer_adp)
{
 ...
 */
__STATIC_INLINE
void hal_timer_set_imr_rtl8195bhp (phal_timer_adapter_t ptimer_adp, u8 imr)
{
 ...
 */
__STATIC_INLINE
void hal_timer_set_opmode_rtl8195bhp (phal_timer_adapter_t ptimer_adp, timer_op_mode_t op_mode)
{
 ...
 */
__STATIC_INLINE
void hal_timer_set_cntmode_rtl8195bhp (phal_timer_adapter_t ptimer_adp, timer_cnt_mode_t cnt_mode)
{
 ...
 */
__STATIC_INLINE
u32 hal_timer_read_isr_rtl8195bhp (phal_timer_adapter_t ptimer_adp)
{
 ...
 */
__STATIC_INLINE
void hal_timer_clear_isr_rtl8195bhp (phal_timer_adapter_t ptimer_adp, u32 int_ev)
{
    ptimer_adp->tmr_ba->isr = int_ev;
}

u32 hal_timer_convert_ticks_to_us_rtl8195bhp  (u32 ticks, u8 sclk_idx);
u32 hal_timer_convert_us_to_ticks_rtl8195bhp  (u32 time_us, u8 sclk_idx);
u64 hal_timer_convert_ticks_to_us64_rtl8195bhp  (u64 ticks, u8 sclk_idx);
u64 hal_timer_convert_us_to_ticks64_rtl8195bhp  (u64 time_us, u8 sclk_idx);
void hal_timer_irq_handler_rtl8195bhp (void *hid);
void hal_timer_me_ctrl_rtl8195bhp (phal_timer_adapter_t ptimer_adp, timer_match_event_t match_ev, u8 enable);
void hal_timer_set_me_counter_rtl8195bhp (phal_timer_adapter_t ptimer_adp, timer_match_event_t match_ev, u32 counter);
void hal_timer_group_en_ctrl_rtl8195bhp (uint32_t tgid, BOOL en);
void hal_timer_group_pclk_ctrl_rtl8195bhp (uint32_t tgid, BOOL en);
void hal_timer_group_sclk_ctrl_rtl8195bhp (uint32_t tgid, BOOL en);
void hal_timer_group_intclk_sel_rtl8195bhp (uint32_t tgid, timer_interrupt_clk_t clk_sel);
void hal_timer_group_sclk_sel_rtl8195bhp (hal_timer_group_adapter_t *ptg_adp, u32 sclk_freq);
void hal_timer_group_init_rtl8195bhp (hal_timer_group_adapter_t *ptg_adp, uint32_t tgid);
void hal_timer_group_deinit_rtl8195bhp (hal_timer_group_adapter_t *ptg_adp);
hal_status_t hal_timer_bare_init_rtl8195bhp (phal_timer_adapter_t ptimer_adp, timer_id_t tid);
void hal_timer_deinit_rtl8195bhp (phal_timer_adapter_t ptimer_adp);
void hal_timer_group_reg_irq_rtl8195bhp (hal_timer_group_adapter_t *ptg_adp, irq_handler_t irq_handler);
void hal_timer_reg_toirq_rtl8195bhp (phal_timer_adapter_t ptimer_adp, timer_callback_t callback, void *phid);
void hal_timer_unreg_toirq_rtl8195bhp (phal_timer_adapter_t ptimer_adp);
void hal_timer_reg_meirq_rtl8195bhp (phal_timer_adapter_t ptimer_adp, u8 match_ev,
                                     timer_callback_t callback, void *phid);
void hal_timer_unreg_meirq_rtl8195bhp (phal_timer_adapter_t ptimer_adp, u8 match_ev);
u32 hal_timer_set_tick_time_rtl8195bhp (phal_timer_adapter_t ptimer_adp, u32 tick_ns);
void hal_timer_init_free_run_rtl8195bhp (phal_timer_adapter_t ptimer_adp, timer_id_t tid,
                                         timer_cnt_mode_t cnt_mode, u32 tick_us);
u32 hal_timer_indir_read_rtl8195bhp (phal_timer_adapter_t ptimer_adp);
u64 hal_timer_read_us_rtl8195bhp (phal_timer_adapter_t ptimer_adp);
u64 hal_timer_read_us64_rtl8195bhp (phal_timer_adapter_t ptimer_adp);
hal_status_t hal_timer_init_rtl8195bhp (phal_timer_adapter_t ptimer_adp, timer_id_t tid);
u32 hal_timer_set_timeout_rtl8195bhp (phal_timer_adapter_t ptimer_adp, u32 time_us, u32 res_us);
void hal_timer_start_rtl8195bhp (phal_timer_adapter_t ptimer_adp, timer_app_mode_t reload_mode);
hal_status_t hal_timer_enable_match_event_rtl8195bhp (phal_timer_adapter_t ptimer_adp, timer_match_event_t match_ev, u32 time_us);
void hal_timer_start_one_shot_rtl8195bhp (phal_timer_adapter_t ptimer_adp, u32 time_us,
                                           timer_callback_t callback, void *phid);
void hal_timer_start_periodical_rtl8195bhp (phal_timer_adapter_t ptimer_adp, u32 time_us,
                                            timer_callback_t callback, void *phid);
timer_id_t hal_timer_allocate_rtl8195bhp (u8 *timer_list);

timer_id_t hal_timer_event_init_rtl8195bhp (phal_timer_adapter_t ptimer_adp, u32 *ptick_us, timer_id_t *timer_list);

void hal_timer_event_deinit_rtl8195bhp (timer_id_t tid);
