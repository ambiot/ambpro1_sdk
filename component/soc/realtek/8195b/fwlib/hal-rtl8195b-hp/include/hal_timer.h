...
u32 hal_timer_set_timeout_rtl8195bhp_patch (phal_timer_adapter_t ptimer_adp, u32 time_us, u32 res_us);
void hal_timer_start_periodical_rtl8195bhp_patch (phal_timer_adapter_t ptimer_adp, u32 time_us,
...
{
#if (CHIP_VER == CHIP_A_CUT) && (defined(CONFIG_BUILD_RAM))
    return hal_timer_set_timeout_rtl8195bhp_patch (ptimer_adp, time_us, res_us);
#else
...
{
    #if (CHIP_VER == CHIP_A_CUT) && (defined(CONFIG_BUILD_RAM))
        hal_timer_start_periodical_rtl8195bhp_patch(ptimer_adp, time_us, callback, phid);
    #else
