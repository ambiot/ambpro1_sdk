...
#ifndef _RTL8195BHP_FLASH_H_
#define _RTL8195BHP_FLASH_H_
...
void flash_read_unique_id_rtl8195bhp(void *adaptor, uint8_t *buf, uint8_t len);
hal_status_t flash_read_id_rtl8195bhp(void *adaptor);
void flash_set_write_enable_rtl8195bhp(void *adaptor);
void flash_set_status_rtl8195bhp(void *adaptor, u8 cmd, u8 data);
void flash_set_status_no_check_rtl8195bhp(void *adaptor, u8 cmd, u8 data);
void flash_set_status_with_addr_rtl8195bhp(void *adaptor, u8 cmd, u8 addr, u8 data);
void flash_set_extended_addr_rtl8195bhp(void *adaptor, u8 data);
void flash_set_write_protect_mode_rtl8195bhp(void *adaptor, u8 mode);
u8 flash_get_status_rtl8195bhp(void *adaptor, u8 cmd);
u8 flash_get_status_with_addr_rtl8195bhp(void *adaptor, u8 cmd, u8 addr);
u8 flash_get_extended_addr_rtl8195bhp(void *adaptor);
void flash_wait_ready_rtl8195bhp(void *adaptor);
void flash_chip_erase_rtl8195bhp(void *adaptor);
void flash_64k_block_erase_rtl8195bhp(void *adaptor, u32 address);
void flash_32k_block_erase_rtl8195bhp(void *adaptor, u32 address);
void flash_sector_erase_rtl8195bhp(void *adaptor, u32 address);
u8 flash_query_sector_protect_state_rtl8195bhp(void *adaptor, u32 address);
void flash_protect_sector_rtl8195bhp(void *adaptor, u32 address);
void flash_unprotect_sector_rtl8195bhp(void *adaptor, u32 address);
void flash_global_lock_rtl8195bhp(void *adaptor);
void flash_global_unlock_rtl8195bhp(void *adaptor);
void flash_set_dummy_cycle_rtl8195bhp(void *adaptor);
void flash_set_quad_enable_rtl8195bhp(void *adaptor);
void flash_unset_quad_enable_rtl8195bhp(void *adaptor);
void flash_enable_qpi_rtl8195bhp(void *adaptor);
void flash_enable_opi_rtl8195bhp(void *adaptor);
void flash_return_spi_rtl8195bhp(void *adaptor);
void flash_return_str_rtl8195bhp(void *adaptor);
void flash_enable_opi_dtr_rtl8195bhp(void *adaptor);
void flash_disable_dtr_rtl8195bhp(void *adaptor);
hal_status_t flash_enter_power_down_rtl8195bhp(void *adaptor);
hal_status_t flash_release_from_power_down_rtl8195bhp(void *adaptor);
void flash_stream_read_rtl8195bhp(void *adaptor, u32 length, u32 addr, u8 *data);
void flash_stream_write_rtl8195bhp(void *adaptor, u32 length, u32 addr, u8 *data);
void flash_burst_read_rtl8195bhp(void *adaptor, u32 length, u32 addr, u8 *data);
void flash_burst_write_rtl8195bhp(void *adaptor, u32 length, u32 addr, u8 *data);
void flash_page_program_rtl8195bhp(void *adaptor, u32 length, u32 addr, u8 *data);
void flash_reset_to_spi_rtl8195bhp(void *adaptor);
...
typedef struct hal_flash_func_stubs_s {
    ...
    void (*hal_flash_enable_opi) (void *adaptor);
    void (*hal_flash_return_spi) (void *adaptor);
    void (*hal_flash_return_str) (void *adaptor);
    void (*hal_flash_enable_opi_dtr) (void *adaptor);
    void (*hal_flash_disable_dtr) (void *adaptor);
