...
/**
 *  @brief Lower level SDIO device HAL and hardware initialization.
 ...
 */
__STATIC_INLINE
hal_status_t hal_sdio_dev_init_hw (hal_sdio_dev_adapter_t *psdio_adp)
{
#if (CHIP_VER <= CHIP_B_CUT) && defined(CONFIG_BUILD_RAM)
    return hal_sdio_dev_init_rtl8195bhp_patch (psdio_adp);
#else
    return hal_sdiod_stubs.init (psdio_adp);
#endif
}

/**
 *  @brief To un-initial the SDIO device hardware and the SDIO device HAL adapter.
 ...
 */
__STATIC_INLINE
void hal_sdio_dev_deinit_hw (hal_sdio_dev_adapter_t *psdio_adp)
{
#if (CHIP_VER <= CHIP_B_CUT) && defined(CONFIG_BUILD_RAM)
    hal_sdio_dev_deinit_rtl8195bhp_patch (psdio_adp);
#else
    hal_sdiod_stubs.deinit (psdio_adp);
#endif
}
...
{
#if (CHIP_VER <= CHIP_B_CUT) && defined(CONFIG_BUILD_RAM)
    hal_sdio_dev_enter_critical_rtl8195bhp_patch(psdio_adp);
#else
...
{
#if (CHIP_VER <= CHIP_B_CUT) && (defined(CONFIG_BUILD_RAM))
    hal_sdio_dev_exit_critical_rtl8195bhp_patch(psdio_adp);
#else
...
{
#if (CHIP_VER <= CHIP_B_CUT) && defined(CONFIG_BUILD_RAM)
    hal_sdio_dev_reg_irq_rtl8195bhp_patch(handler);
#else
...
{
#if (CHIP_VER <= CHIP_B_CUT) && defined(CONFIG_BUILD_RAM)
    hal_sdio_dev_syson_ctrl_rtl8195bhp_patch(en);
#else
...
{
#if (CHIP_VER <= CHIP_B_CUT) && defined(CONFIG_BUILD_RAM)
    hal_sdio_dev_task_up_rtl8195bhp_patch(psdio_adp);
#else
...
{
#if (CHIP_VER <= CHIP_B_CUT) && defined(CONFIG_BUILD_RAM)
    hal_sdio_dev_tx_task_rtl8195bhp_patch(psdio_adp);
#else
...
{
#if (CHIP_VER <= CHIP_B_CUT) && defined(CONFIG_BUILD_RAM)
    hal_sdio_dev_rx_task_rtl8195bhp_patch(psdio_adp);
#else
...
{
#if (CHIP_VER <= CHIP_B_CUT) && defined(CONFIG_BUILD_RAM)
    hal_sdio_dev_irq_handler_bh_rtl8195bhp_patch(psdio_adp);
#else
...
{
#if (CHIP_VER <= CHIP_B_CUT) && defined(CONFIG_BUILD_RAM)
    hal_sdio_dev_rx_irq_handler_bh_rtl8195bhp_patch(psdio_adp);
#else
...
{
#if (CHIP_VER <= CHIP_B_CUT) && defined(CONFIG_BUILD_RAM)
    hal_sdio_dev_txbd_buf_refill_rtl8195bhp_patch(psdio_adp);
#else
...
{
#if (CHIP_VER <= CHIP_B_CUT) && defined(CONFIG_BUILD_RAM)
    hal_sdio_dev_tx_fifo_data_ready_rtl8195bhp_patch(psdio_adp);
#else
...
{
#if (CHIP_VER <= CHIP_B_CUT) && defined(CONFIG_BUILD_RAM)
    hal_sdio_dev_recycle_rxbd_rtl8195bhp_patch(psdio_adp);
#else
...
{
#if (CHIP_VER <= CHIP_B_CUT) && defined(CONFIG_BUILD_RAM)
    hal_sdio_dev_return_rx_data_rtl8195bhp_patch(psdio_adp);
#else
...
{
#if (CHIP_VER <= CHIP_B_CUT) && defined(CONFIG_BUILD_RAM)
    return hal_sdio_dev_rx_pkt_enqueue_rtl8195bhp_patch(psdio_adp, ppkt);
#else
