...
#ifndef _RTL8195BH_PWM_H_
#define _RTL8195BH_PWM_H_
...
#include "rtl8195bhp_pwm_comm_type.h"
#include "rtl8195bhp_pwm_type.h"
...
**/
enum  pwm_clk_sel_e {
    PwmClkSrc_Tm8       = GTimer8,    //!< Tick source from G-Timer 8
    PwmClkSrc_Tm9       = GTimer9,    //!< Tick source from G-Timer 9
    PwmClkSrc_Tm10      = GTimer10,   //!< Tick source from G-Timer 10
    PwmClkSrc_Tm11      = GTimer11,   //!< Tick source from G-Timer 11
    PwmClkSrc_Tm12      = GTimer12,   //!< Tick source from G-Timer 12
    PwmClkSrc_Tm13      = GTimer13,   //!< Tick source from G-Timer 13
    PwmClkSrc_Tm14      = GTimer14,   //!< Tick source from G-Timer 14
    PwmClkSrc_Tm15      = GTimer15,   //!< Tick source from G-Timer 15
...
typedef struct hal_pwm_adapter_s {
    ...
    pin_sel_t pin_sel;  /*! IO pin selection for this PWM */
...
typedef struct hal_pwm_func_stubs_s {
    ...
    hal_status_t (*hal_pwm_init) (hal_pwm_adapter_t *ppwm_adp, u8 pwm_id, pin_sel_t pin_sel, u16 duty_res_us);
 ...
 */
__STATIC_INLINE
u32 hal_pwm_comm_enable_sts_rtl8195bhp (hal_pwm_comm_adapter_t *ppwm_com_adp)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_update_ctrl_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_duty_size_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u32 duty_ticks)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_onduty_start_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u32 start_ticks)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_period_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u32 period_ticks)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_pause_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, BOOL pause_ctrl)
{
 ...
 */
__STATIC_INLINE
u8 hal_pwm_get_run_sts_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_period_ie_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, BOOL int_en)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_max_duty_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u32 max_duty_tick)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_min_duty_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u32 min_duty_tick)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_duty_inc_step_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u32 inc_step_ticks)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_duty_dec_step_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u32 dec_step_ticks)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_duty_adj_cycle_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u32 cycle_cnt)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_duty_adj_en_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, BOOLEAN enable)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_duty_adj_dir_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, pwm_duty_adj_dir_t dir)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_duty_loop_mode_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u8 loop_en)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_max_duty_int_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u8 int_en)
{
 ...
 */
__STATIC_INLINE
void hal_pwm_set_min_duty_int_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u8 int_en)
{
    ppwm_adp->base_addr->auto_adj_ctrl_b.duty_dn_lim_ie = int_en;
}

void hal_pwm_comm_irq_reg_rtl8195bhp (irq_handler_t irq_handler);
void hal_pwm_comm_irq_unreg_rtl8195bhp (void);
...
void hal_pwm_comm_init_rtl8195bhp (hal_pwm_comm_adapter_t *ppwm_com_adp);
void hal_pwm_comm_deinit_rtl8195bhp (void);
void hal_pwm_comm_tick_source_list_rtl8195bhp (uint8_t *timer_list);
hal_status_t hal_pwm_init_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u8 pwm_id, pin_sel_t pin_sel, u16 duty_res_us);
BOOLEAN hal_pwm_enable_sts_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp);
void hal_pwm_comm_enable_rtl8195bhp (u32 en_ctrl);
void hal_pwm_comm_disable_rtl8195bhp (u32 dis_ctrl);
void hal_pwm_enable_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp);
void hal_pwm_disable_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp);
void hal_pwm_deinit_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp);
void hal_pwm_set_clk_sel_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, pwm_clk_sel_t clk_sel);
void hal_pwm_wait_ctrl_ready_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp);
hal_status_t hal_pwm_set_tick_time_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u32 tick_p5us);
hal_status_t hal_pwm_set_duty_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u32 period_us,
                                            u32 duty_us, u32 start_offset_us);
u32 hal_pwm_read_duty_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp);
void hal_pwm_change_duty_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u32 duty_us);
hal_status_t hal_pwm_set_duty_limit_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u32 max_duty_us, u32 min_duty_us);
void hal_pwm_set_auto_duty_adj_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, hal_pwm_auto_duty_adj_t *pauto_duty);
void hal_pwm_auto_duty_en_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, BOOLEAN enable);
hal_status_t hal_pwm_set_auto_duty_inc_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u32 max_duty_us,
                                                u32 step_sz_us, u32 step_period_cnt);
hal_status_t hal_pwm_set_auto_duty_dec_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u32 min_duty_us,
                                                u32 step_sz_us, u32 step_period_cnt);
hal_status_t hal_pwm_set_auto_duty_loop_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u8 ini_dir, u32 loop_cnt);
void hal_pwm_set_period_int_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, pwm_period_callback_t callback, \
                                        void *arg, u8 int_en);
void hal_pwm_set_autoadj_int_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, pwm_lim_callback_t callback, \
                                        void *arg, u8 int_en);
void hal_pwm_set_autoadj_loop_int_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, pwm_lo_callback_t callback, void *arg);

hal_status_t hal_pwm_auto_duty_inc_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u32 max_duty_us,
                                                u32 step_sz_us, u32 step_period_cnt);
hal_status_t hal_pwm_auto_duty_dec_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u32 min_duty_us,
                                                u32 step_sz_us, u32 step_period_cnt);
hal_status_t hal_pwm_auto_duty_loop_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u32 ini_duty_us, u8 ini_dir, u32 loop_cnt);
void hal_pwm_stop_duty_loop_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u8 stop_now);
hal_status_t hal_pwm_set_duty_ns_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u32 period_ns,
                                            u32 duty_ns, u32 start_offset_ns);
hal_status_t hal_pwm_auto_duty_ns_inc_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u32 max_duty_ns,
                                                u32 step_sz_ns, u32 step_period_cnt);
hal_status_t hal_pwm_auto_duty_ns_dec_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp, u32 min_duty_ns,
                                                u32 step_sz_ns, u32 step_period_cnt);
u32 hal_pwm_read_duty_ns_rtl8195bhp (hal_pwm_adapter_t *ppwm_adp);
