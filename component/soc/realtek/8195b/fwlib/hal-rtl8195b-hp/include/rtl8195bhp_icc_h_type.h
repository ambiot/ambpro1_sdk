/**************************************************************************//**
 * @file      rtl8195bhp_icc_h_type.h
 * @brief
 * @version   V1.00
 * @date      2019-7-16 15:39:52
 *
 * @note
 *
 ******************************************************************************
...
#ifndef _RTL8195BHP_ICC_H_TYPE_H_
#define _RTL8195BHP_ICC_H_TYPE_H_
...
/**
 * @addtogroup hs_hal_icc_h_reg ICC_H Registers.
 * @ingroup hs_hal_icc
 * @{
 */

/**
  \brief Union type to access icc_h_icch_hrlw0 (@ 0x00000000).
*/
typedef union {
  ...
  struct {
    __IM  uint32_t hrlw       : 32;           /*!< [31..0] The information maintained by LP CPU. It could be message
                                                   ...
                                                   of Q_H2L.                                                                 */
  } b;                                        /*!< bit fields for icc_h_icch_hrlw0 */
} icc_h_icch_hrlw0_t, *picc_h_icch_hrlw0_t;

/**
  \brief Union type to access icc_h_icch_hrlw1 (@ 0x00000004).
*/
typedef union {
  ...
  struct {
    __IM  uint32_t hrlw       : 32;           /*!< [31..0] The information maintained by LP CPU. It could be message
                                                   queue information: write pointer Q_L2H or the read pointer
                                                   of Q_H2L.                                                                 */
  } b;                                        /*!< bit fields for icc_h_icch_hrlw1 */
} icc_h_icch_hrlw1_t, *picc_h_icch_hrlw1_t;

/**
  \brief Union type to access icc_h_icch_hrlw2 (@ 0x00000008).
*/
typedef union {
  ...
  struct {
    __IM  uint32_t hrlw       : 32;           /*!< [31..0] The information maintained by LP CPU. It could be message
                                                   queue information: write pointer Q_L2H or the read pointer
                                                   of Q_H2L.                                                                 */
  } b;                                        /*!< bit fields for icc_h_icch_hrlw2 */
} icc_h_icch_hrlw2_t, *picc_h_icch_hrlw2_t;

/**
  \brief Union type to access icc_h_icch_hrlw3 (@ 0x0000000C).
*/
typedef union {
  ...
  struct {
    __IM  uint32_t hrlw       : 32;           /*!< [31..0] The information maintained by LP CPU. It could be message
                                                   queue information: write pointer Q_L2H or the read pointer
                                                   of Q_H2L.                                                                 */
  } b;                                        /*!< bit fields for icc_h_icch_hrlw3 */
} icc_h_icch_hrlw3_t, *picc_h_icch_hrlw3_t;

/**
  \brief Union type to access icc_h_icch_lptg (@ 0x00000010).
*/
typedef union {
  ...
  } b;                                        /*!< bit fields for icc_h_icch_lptg */
} icc_h_icch_lptg_t, *picc_h_icch_lptg_t;

/**
  \brief Union type to access icc_h_icch_sema (@ 0x00000018).
*/
typedef union {
  ...
  } b;                                        /*!< bit fields for icc_h_icch_sema */
} icc_h_icch_sema_t, *picc_h_icch_sema_t;

/**
  \brief Union type to access icc_h_icch_hlrw0 (@ 0x00000020).
*/
typedef union {
  ...
  } b;                                        /*!< bit fields for icc_h_icch_hlrw0 */
} icc_h_icch_hlrw0_t, *picc_h_icch_hlrw0_t;

/**
  \brief Union type to access icc_h_icch_hlrw1 (@ 0x00000024).
*/
typedef union {
  ...
  } b;                                        /*!< bit fields for icc_h_icch_hlrw1 */
} icc_h_icch_hlrw1_t, *picc_h_icch_hlrw1_t;

/**
  \brief Union type to access icc_h_icch_hlrw2 (@ 0x00000028).
*/
typedef union {
  ...
  struct {
    __IOM uint32_t hlrw       : 32;           /*!< [31..0] The information could be writen by LP CPU or HP_CPU.
                                                   It could be used as hardware semaphores.                                  */
  } b;                                        /*!< bit fields for icc_h_icch_hlrw2 */
} icc_h_icch_hlrw2_t, *picc_h_icch_hlrw2_t;

/**
  \brief Union type to access icc_h_icch_hlrw3 (@ 0x0000002C).
*/
typedef union {
  ...
  struct {
    __IOM uint32_t hlrw       : 32;           /*!< [31..0] The information could be writen by LP CPU or HP_CPU.
                                                   It could be used as hardware semaphores.                                  */
  } b;                                        /*!< bit fields for icc_h_icch_hlrw3 */
} icc_h_icch_hlrw3_t, *picc_h_icch_hlrw3_t;

/**
  \brief Union type to access icc_h_icch_hwlr0 (@ 0x00000030).
*/
typedef union {
  ...
  } b;                                        /*!< bit fields for icc_h_icch_hwlr0 */
} icc_h_icch_hwlr0_t, *picc_h_icch_hwlr0_t;

/**
  \brief Union type to access icc_h_icch_hwlr1 (@ 0x00000034).
*/
typedef union {
  ...
  struct {
    __IOM uint32_t hwlr       : 32;           /*!< [31..0] The information maintained by HP CPU. It could be message
                                                   queue information: start address, queue size, write pointer
                                                   Q_H2L or the read pointer of Q_L2H.                                       */
  } b;                                        /*!< bit fields for icc_h_icch_hwlr1 */
} icc_h_icch_hwlr1_t, *picc_h_icch_hwlr1_t;

/**
  \brief Union type to access icc_h_icch_hwlr2 (@ 0x00000038).
*/
typedef union {
  ...
  struct {
    __IOM uint32_t hwlr       : 32;           /*!< [31..0] The information maintained by HP CPU. It could be message
                                                   queue information: start address, queue size, write pointer
                                                   Q_H2L or the read pointer of Q_L2H.                                       */
  } b;                                        /*!< bit fields for icc_h_icch_hwlr2 */
} icc_h_icch_hwlr2_t, *picc_h_icch_hwlr2_t;

/**
  \brief Union type to access icc_h_icch_hwlr3 (@ 0x0000003C).
*/
typedef union {
  ...
  struct {
    __IOM uint32_t hwlr       : 32;           /*!< [31..0] The information maintained by HP CPU. It could be message
                                                   queue information: start address, queue size, write pointer
                                                   Q_H2L or the read pointer of Q_L2H.                                       */
  } b;                                        /*!< bit fields for icc_h_icch_hwlr3 */
} icc_h_icch_hwlr3_t, *picc_h_icch_hwlr3_t;

/**
  \brief Union type to access icc_h_icch_hwlr4 (@ 0x00000040).
*/
typedef union {
  ...
  struct {
    __IOM uint32_t hwlr       : 32;           /*!< [31..0] The information maintained by HP CPU. It could be message
                                                   queue information: start address, queue size, write pointer
                                                   Q_H2L or the read pointer of Q_L2H.                                       */
  } b;                                        /*!< bit fields for icc_h_icch_hwlr4 */
} icc_h_icch_hwlr4_t, *picc_h_icch_hwlr4_t;

/**
  \brief Union type to access icc_h_icch_hwlr5 (@ 0x00000044).
*/
typedef union {
  ...
  struct {
    __IOM uint32_t hwlr       : 32;           /*!< [31..0] The information maintained by HP CPU. It could be message
                                                   queue information: start address, queue size, write pointer
                                                   Q_H2L or the read pointer of Q_L2H.                                       */
  } b;                                        /*!< bit fields for icc_h_icch_hwlr5 */
} icc_h_icch_hwlr5_t, *picc_h_icch_hwlr5_t;

/**
  \brief Union type to access icc_h_icch_hwlr6 (@ 0x00000048).
*/
typedef union {
  ...
  struct {
    __IOM uint32_t hwlr       : 32;           /*!< [31..0] The information maintained by HP CPU. It could be message
                                                   queue information: start address, queue size, write pointer
                                                   Q_H2L or the read pointer of Q_L2H.                                       */
  } b;                                        /*!< bit fields for icc_h_icch_hwlr6 */
} icc_h_icch_hwlr6_t, *picc_h_icch_hwlr6_t;

/**
  \brief Union type to access icc_h_icch_hwlr7 (@ 0x0000004C).
*/
typedef union {
  ...
  struct {
    __IOM uint32_t hwlr       : 32;           /*!< [31..0] The information maintained by HP CPU. It could be message
                                                   queue information: start address, queue size, write pointer
                                                   Q_H2L or the read pointer of Q_L2H.                                       */
  } b;                                        /*!< bit fields for icc_h_icch_hwlr7 */
} icc_h_icch_hwlr7_t, *picc_h_icch_hwlr7_t;

/**
  \brief Union type to access icc_h_icch_hptg (@ 0x00000050).
*/
typedef union {
  ...
  } b;                                        /*!< bit fields for icc_h_icch_hptg */
} icc_h_icch_hptg_t, *picc_h_icch_hptg_t;

/**
  \brief Union type to access icc_h_icch_lptgie (@ 0x00000054).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000054) LP Toggle Interrupt Enable Register                        */
  ...
  } b;                                        /*!< bit fields for icc_h_icch_lptgie */
} icc_h_icch_lptgie_t, *picc_h_icch_lptgie_t;

/**
  \brief Union type to access icc_h_icch_lptgis (@ 0x00000058).
*/
typedef union {
  __IOM uint32_t w;                           /*!< (@ 0x00000058) LP Toggle Interrupt Status Register                        */
  ...
  struct {
    ...
    __IOM uint32_t l2htgiss   : 1;            /*!< [20..20] This bit is used to show the interrupt status which
                                                   ...
                                                   1: Interrupt is pending. Write 1 to clear.                                */
  } b;                                        /*!< bit fields for icc_h_icch_lptgis */
} icc_h_icch_lptgis_t, *picc_h_icch_lptgis_t;

/** @} */ /* End of group hs_hal_icc_h_reg */
...
#endif    // end of #ifndef _RTL8195BHP_ICC_H_TYPE_H_
