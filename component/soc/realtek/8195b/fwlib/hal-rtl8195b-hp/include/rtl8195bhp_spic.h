...
#ifndef RTL8195BHP_SPIC_H
#define RTL8195BHP_SPIC_H
...
#define MAX_BAUD_RATE 0xA              //!< Define maximum baud rate of flash controller
...
typedef struct _hal_spic_adaptor_s {
    ...
    spic_init_para_t spic_init_data[10][CPU_CLK_TYPE_NO];   //!< Calibration settings for various IO mode with different CPU clock
    ...
    u8   seq_dum_len[10];                                   //!< Dummy cycle of sequentail read mode for various IO modes
...
typedef struct hal_spic_func_stubs_s {
    const uint8_t *spic_dual_pin;
    const uint8_t *spic_quad_pin;
    const uint8_t *spic_octal_pin;
    ...
    hal_status_t (*spic_init_rom)(phal_spic_adaptor_t phal_spic_adaptor, u8 spic_bit_mode, u8 io_pin_sel);
    hal_status_t (*spic_deinit_rom)(phal_spic_adaptor_t phal_spic_adaptor);
...
/** \brief Description of spic_enable_rtl8195bhp
 *
 *    spic_enable_rtl8195bhp is used to enable flash controller.
 *
 *   \param SPIC_Type *spic_dev:      The pointer of the flash controller register base.
 *
 *   \return void.
 */
static inline void spic_enable_rtl8195bhp(SPIC_Type *spic_dev)
{
    spic_dev->ssienr = ENABLE;
}

/** \brief Description of spic_disable_rtl8195bhp
 *
 *    spic_disable_rtl8195bhp is used to disable flash controller.
 ...
 *   \return void.
 */
static inline void spic_disable_rtl8195bhp(SPIC_Type *spic_dev)
{
    spic_dev->ssienr = DISABLE;
}


/** \brief Description of spic_set_ctrl1_rtl8195bhp
 *
 *    spic_set_ctrl1_rtl8195bhp is used to set number of data frames (data length)expect to receive in user mode.
 ...
 *   \return void.
 */
static inline void spic_set_ctrl1_rtl8195bhp(SPIC_Type *spic_dev, u32 length)
{
    spic_dev->ctrlr1_b.ndf = length;
}

/** \brief Description of spic_set_baudr_rtl8195bhp
 *
 *    spic_set_baudr_rtl8195bhp is used to flush FIFO of the flash controller.
 *    The flash controller should be disabled to set the register correctly.
 *
 *   \param SPIC_Type *spic_dev:      The pointer of the flash controller register base.
 ...
 *   \return void.
 */
static inline void spic_set_baudr_rtl8195bhp(SPIC_Type *spic_dev, u8 baudr)
{
    spic_dev->baudr_b.sckdv = baudr;
}

/** \brief Description of spic_set_fbaudr_rtl8195bhp
 *
 *    spic_set_fbaudr_rtl8195bhp is used to set baud rate of the flash controller for fast read.
 *    The flash controller should be disabled to set the register correctly.
 *
 *   \param SPIC_Type *spic_dev:      The pointer of the flash controller register base.
 ...
 *   \return void.
 */
static inline void spic_set_fbaudr_rtl8195bhp(SPIC_Type *spic_dev, u8 fbaudr)
{
    spic_dev->fbaudr_b.fsckdv = fbaudr;
}

/** \brief Description of spic_set_dummy_cycle_rtl8195bhp
 *
 *    spic_set_dummy_cycle_rtl8195bhp is used to tune timing to receive data correctly.
 ...
 *   \return void.
 */
static inline void spic_set_dummy_cycle_rtl8195bhp(SPIC_Type *spic_dev, u8 dummy_cycle)
{
    spic_dev->auto_length_b.rd_dummy_length = (u16)dummy_cycle;
}

/** \brief Description of spic_get_baudr_rtl8195bhp
 *
 *    spic_get_baudr_rtl8195bhp is used to get baud rate setting of the flash controller.
 *
 *   \param SPIC_Type *spic_dev:      The pointer of the flash controller register base.
 *
 *   \return u8: value of baud rate divider.
 */
static inline u8 spic_get_baudr_rtl8195bhp(SPIC_Type *spic_dev)
{
    u8 baudr = 0;
...
/** \brief Description of spic_get_fbaudr_rtl8195bhp
 *
 *    spic_get_fbaudr_rtl8195bhp is used to get baud rate setting of the flash controller for fast read.
 *
 *   \param SPIC_Type *spic_dev:      The pointer of the flash controller register base.
 *
 *   \return u8: value of baud rate divider.
 */
static inline u8 spic_get_fbaudr_rtl8195bhp(SPIC_Type *spic_dev)
{
    u8 fbaudr = 0;
...
void spic_load_default_setting_rtl8195bhp(pspic_init_para_t pspic_init_data);
u8 spic_query_system_clk_rtl8195bhp(void);
void spic_clock_ctrl_rtl8195bhp(u8 ctl);
void spic_pin_ctrl_rtl8195bhp(u8 io_pin_sel, u8 ctl);
hal_status_t spic_init_setting_rtl8195bhp(phal_spic_adaptor_t phal_spic_adaptor, u8 spic_bit_mode);
void spic_config_dtr_read_rtl8195bhp(phal_spic_adaptor_t phal_spic_adaptor);
void spic_config_auto_mode_rtl8195bhp(phal_spic_adaptor_t phal_spic_adaptor);
void spic_config_user_mode_rtl8195bhp(phal_spic_adaptor_t phal_spic_adaptor);
BOOL spic_verify_calibration_para_rtl8195bhp(void);
void spic_enable_seq_read_rtl8195bhp(phal_spic_adaptor_t phal_spic_adaptor);
void spic_disable_seq_read_rtl8195bhp(phal_spic_adaptor_t phal_spic_adaptor);
void spic_set_chnl_num_rtl8195bhp(phal_spic_adaptor_t phal_spic_adaptor);
void spic_set_delay_line_rtl8195bhp(u8 delay_line);
void spic_rx_cmd_8io_rtl8195bhp(phal_spic_adaptor_t phal_spic_adaptor, u8 cmd, u8 data_phase_len, u8 *pdata);
void spic_rx_cmd_4io_rtl8195bhp(phal_spic_adaptor_t phal_spic_adaptor, u8 cmd, u8 data_phase_len, u8 *pdata);
void spic_rx_cmd_rtl8195bhp(phal_spic_adaptor_t phal_spic_adaptor, u8 cmd, u8 data_phase_len, u8 *pdata);
void spic_tx_cmd_8io_rtl8195bhp(phal_spic_adaptor_t phal_spic_adaptor, u8 cmd, u8 data_phase_len, u8 *pdata);
void spic_tx_cmd_4io_rtl8195bhp(phal_spic_adaptor_t phal_spic_adaptor, u8 cmd, u8 data_phase_len, u8 *pdata);
void spic_tx_cmd_8io_no_check_rtl8195bhp(phal_spic_adaptor_t phal_spic_adaptor, u8 cmd, u8 data_phase_len, u8 *pdata);
void spic_tx_cmd_4io_no_check_rtl8195bhp(phal_spic_adaptor_t phal_spic_adaptor, u8 cmd, u8 data_phase_len, u8 *pdata);
void spic_tx_cmd_no_check_rtl8195bhp(phal_spic_adaptor_t phal_spic_adaptor, u8 cmd, u8 data_phase_len, u8 *pdata);
void spic_tx_cmd_rtl8195bhp(phal_spic_adaptor_t phal_spic_adaptor, u8 cmd, u8 data_phase_len, u8 *pdata);
void spic_wait_ready_rtl8195bhp(SPIC_Type *spic_dev);
void spic_flush_fifo_rtl8195bhp(SPIC_Type *spic_dev);
