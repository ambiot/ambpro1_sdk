...
#ifndef _RTL8195BHP_SDIOD_H_
#define _RTL8195BHP_SDIOD_H_
...
* @ingroup 8710c_hal
* @{
* @brief The SDIO Device HAL module of the HS platform.
*/

#include "rtl8195bhp_sdio_dev_type.h"
#include "dlist.h"
...
enum SDIOD_MSG_TYPE_E {
    ...
    MSG_SDIO_MP_LOOP_TXPKT  = 4,        ///< for loopback test: request to loopback this TX packet
 ...
 * @{
 */
void hal_sdio_dev_enter_critical_rtl8195bhp (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_exit_critical_rtl8195bhp (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_reg_irq_rtl8195bhp (irq_handler_t handler);
void hal_sdio_dev_int_def_enable (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_syson_ctrl_rtl8195bhp(BOOL en);
hal_status_t hal_sdio_dev_init_rtl8195bhp (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_deinit_rtl8195bhp (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_task_up_rtl8195bhp (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_tx_task_rtl8195bhp (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_rx_task_rtl8195bhp (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_irq_handler_bh_rtl8195bhp (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_rx_irq_handler_bh_rtl8195bhp (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_txbd_buf_refill_rtl8195bhp (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_tx_fifo_data_ready_rtl8195bhp (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_recycle_rxbd_rtl8195bhp (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_return_rx_data_rtl8195bhp (hal_sdio_dev_adapter_t *psdio_adp);
hal_status_t hal_sdio_dev_rx_pkt_enqueue_rtl8195bhp (hal_sdio_dev_adapter_t *psdio_adp, sdiod_rx_packet_t *ppkt);

#if defined(CONFIG_BUILD_RAM)
void hal_sdio_dev_enter_critical_rtl8195bhp_patch (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_exit_critical_rtl8195bhp_patch (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_reg_irq_rtl8195bhp_patch (irq_handler_t handler);
void hal_sdio_dev_syson_ctrl_rtl8195bhp_patch(BOOL en);
hal_status_t hal_sdio_dev_init_rtl8195bhp_patch (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_deinit_rtl8195bhp_patch (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_task_up_rtl8195bhp_patch (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_tx_task_rtl8195bhp_patch (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_rx_task_rtl8195bhp_patch (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_irq_handler_bh_rtl8195bhp_patch (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_rx_irq_handler_bh_rtl8195bhp_patch (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_txbd_buf_refill_rtl8195bhp_patch (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_tx_fifo_data_ready_rtl8195bhp_patch (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_recycle_rxbd_rtl8195bhp_patch (hal_sdio_dev_adapter_t *psdio_adp);
void hal_sdio_dev_return_rx_data_rtl8195bhp_patch (hal_sdio_dev_adapter_t *psdio_adp);
hal_status_t hal_sdio_dev_rx_pkt_enqueue_rtl8195bhp_patch (hal_sdio_dev_adapter_t *psdio_adp, sdiod_rx_packet_t *ppkt);
#endif
...
#endif  // #ifndef _RTL8195BHP_SDIOD_H_
