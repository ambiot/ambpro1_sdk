...
#ifndef _RTL8195BHP_SPIC_TYPE_H_
#define _RTL8195BHP_SPIC_TYPE_H_
...
/**
 * @addtogroup hs_hal_spic_reg Flash Controller Registers.
 * @ingroup hs_hal_spic
 * @{
 */
...
#endif    // end of #ifndef _RTL8195BHP_SPIC_TYPE_H_
