/**************************************************************************//**
 * @file      rtl8195bhp_ssi_type.h
 * @brief    Define SSI register struct for local use
 * @version   V1.00
...
#ifndef _RTL8195BHP_SSI_TYPE_H_
#define _RTL8195BHP_SSI_TYPE_H_
...
/**
 * @addtogroup hs_hal_ssi_reg SPI Registers.
 * @ingroup hs_hal_ssi
 * @brief List all SPI registers and bit field definition of each register
 * @{
 */
...
/**
  \brief Union type to access ssi_imr_slv (@ 0x0000002C).
*/
typedef union {
  __IOM uint32_t w;                         /*!< (@ 0x0000002C) Interrupt Mask of RTK-SPI Slave Register                   */
  ...
  struct {
    ...
    __IOM uint32_t ssrim    : 1;            /*!< [7..7] SS_N Rising Edge Detect Interrupt Mask 0 : ssi_ssr_intr
                                                 interrupt is masked 1 : ssi_ssr_intr interrupt is not masked              */
  } b;                                        /*!< bit fields for ssi_imr_slv */
} ssi_imr_slv_t, *pssi_imr_slv_t;
...
/**
  \brief Union type to access ssi_isr_slv (@ 0x00000030).
*/
typedef union {
  __IOM uint32_t w;                         /*!< (@ 0x00000030) Interrupt Status Register                                  */
  ...
  struct {
    ...
    __IM  uint32_t ssris    : 1;            /*!< [7..7] SS_N Rising Edge Detect Interrupt Status 0 = ssi_ssr_intr
                                                 interrupt is not active after masking 1 = ssi_ssr_intr
                                                 interrupt is active after masking                                         */
  } b;                                        /*!< bit fields for ssi_isr_slv */
} ssi_isr_slv_t, *pssi_isr_slv_t;
...
/**
  \brief Union type to access ssi_risr_slv (@ 0x00000034).
*/
typedef union {
  __IOM uint32_t w;                         /*!< (@ 0x00000034) Raw Interrupt Status Register                              */
  ...
  struct {
    ...
    __IM  uint32_t ssrir    : 1;            /*!< [7..7] SS_N Rising Edge Detect Raw Interrupt Status 0 = ssi_ssr_intr
                                                 interrupt is not active prior to masking 1 = ssi_ssr_intr
                                                 interrupt is active prior to masking                                      */
  } b;                                        /*!< bit fields for ssi_risr_slv */
} ssi_risr_slv_t, *pssi_risr_slv_t;
...
/**
  \brief Union type to access ssi_faeicr (@ 0x00000044).
*/
typedef union {
  ...
  } b;                                        /*!< bit fields for ssi_faeicr */
} ssi_faeicr_t, *pssi_faeicr_t;
...
#endif    // end of #ifndef _RTL8195BHP_SSI_TYPE_H_
