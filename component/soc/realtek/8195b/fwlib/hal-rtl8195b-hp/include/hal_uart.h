...
/**
 *  @brief To enable or disable UART TX and RX pins.
 *
 *  @param[in]  uart_idx The UART index. The value can be 0 .. 2.
 *  @param[in]  pin_sel The pin mux selection.
 *  @param[in]  en  Pin enable control:
 *                    - 0: Disable TX and RX pins.
 *                    - 1: Enable TX and RX pins.
 *
 *  @returns    void
 */
__STATIC_INLINE hal_status_t hal_uart_tr_pin_ctrl (uint8_t uart_idx, uart_pin_sel_t pin_sel, BOOL en)
{
    return hal_uart_stubs.hal_uart_tr_pin_ctrl (uart_idx, pin_sel, en);
}

/**
 *  @brief To enable or disable UART RTS and CTS pins.
 *
 *  @param[in]  uart_idx The UART index. The value can be 0 .. 2.
 *  @param[in]  pin_sel The pin mux selection.
 *  @param[in]  en  Pin enable control:
 *                    - 0: Disable RTS and CTS pins.
 *                    - 1: Enable RTS and CTS pins.
 *
 *  @returns    void
 */
__STATIC_INLINE hal_status_t hal_uart_flc_pin_ctrl (uint8_t uart_idx, uart_pin_sel_t pin_sel, BOOL en)
{
    return hal_uart_stubs.hal_uart_flc_pin_ctrl (uart_idx, pin_sel, en);
}
