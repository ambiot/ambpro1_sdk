...
#ifndef _RTL8195BH_MISC_H_
#define _RTL8195BH_MISC_H_
 ...
 */
__STATIC_INLINE
void hal_misc_wdt_enable_rtl8195bhp (void)
{
 ...
 */
__STATIC_INLINE
void hal_misc_wdt_disable_rtl8195bhp (void)
{
 ...
 */
__STATIC_INLINE
void hal_misc_wdt_refresh_rtl8195bhp (void)
{
...
void hal_misc_init_rtl8195bhp (hal_misc_adapter_t *pmisc_adp);
void hal_misc_start_systimer_rtl8195bhp (phal_timer_adapter_t ptimer_adp, uint32_t tmr_id,
                                            timer_cnt_mode_t cnt_md, uint32_t tick_us);
u64 hal_misc_read_systime_rtl8195bhp (void);
u32 hal_misc_read_curtime_rtl8195bhp (void);
void hal_misc_delay_us_rtl8195bhp (u32 time_us);
BOOLEAN hal_misc_is_timeout (u32 start_us, u32 timeout_us);
void hal_misc_wdt_set_timeout_rtl8195bhp (uint32_t time_us);
void hal_misc_wdt_init_rtl8195bhp (uint32_t time_us);
void hal_misc_wdt_reg_irq_rtl8195bhp (irq_handler_t handler, void *arg);
void hal_misc_nmi_reg_irq_rtl8195bhp (irq_handler_t handler, void *arg);
void hal_misc_rst_by_wdt_rtl8195bhp (void);
void hal_misc_cpu_rst_rtl8195bhp (void);
...
#define hal_read_sys_time()                     hal_misc_read_systime_rtl8195bhp()
#define hal_read_cur_time()                     hal_misc_read_curtime_rtl8195bhp()
#define hal_is_timeout(start_us, timeout_us)    hal_misc_is_timeout(start_us, timeout_us)
#define hal_delay_us(time_us)                   do {hal_misc_delay_us_rtl8195bhp (time_us);} while (0)
#define hal_delay_ms(time_ms)                   do {hal_misc_delay_us_rtl8195bhp ((time_ms)*1000);} while (0)
#else
...
#endif  // end of "#define _RTL8195BH_MISC_H_"
