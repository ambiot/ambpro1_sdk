 ...
 *
 * @file     rtl8195bhp_dpi.h
 * @brief    CMSIS HeaderFile
 * @version  1.0
 * @date     22. June 2018
 * @note     Generated by SVDConv V3.3.18 on Friday, 22.06.2018 11:32:03
 *           from File 'rtl8195b-hp-dpi.svd',
 *           last modified on Friday, 22.06.2018 03:32:01
 */


#ifndef RTL8195BHP_DPI_H
#define RTL8195BHP_DPI_H
...
typedef struct {                                /*!< (@ 0x40402000) DPI Structure                                              */
  ...
  union {
    __IOM uint32_t cal_ls_sel_0;                /*!< (@ 0x00000298) Calibration Left Shift Select 0                            */
  ...
  union {
    __IOM uint32_t cal_ls_sel_1;                /*!< (@ 0x0000029C) Calibration Left Shift Select 1                            */
  ...
  union {
    __IOM uint32_t cal_rs_sel_0;                /*!< (@ 0x000002A8) Calibration Right Shift Select 0                           */
  ...
  union {
    __IOM uint32_t cal_rs_sel_1;                /*!< (@ 0x000002AC) Calibration Right Shift Select 1                           */
  ...
  union {
    __IOM uint32_t dq_pad_ctrl;                 /*!< (@ 0x0000031C) DQ PAD Control Register                                    */
  ...
  union {
    __IOM uint32_t dq_pad_ctrl1;                /*!< (@ 0x00000320) DQ PAD Control Register 1                                  */
  ...
  union {
    __IOM uint32_t dqs_p_pad_ctrl1;             /*!< (@ 0x00000328) DQS P Pad Control Register 1                               */
  ...
  union {
    __IOM uint32_t dqs_n_pad_ctrl;              /*!< (@ 0x0000032C) DQS N Pad Control Register                                 */
  ...
  union {
    __IOM uint32_t dqs_n_pad_ctrl1;             /*!< (@ 0x00000330) DQS N Pad Control Register 1                               */
  ...
  union {
    __IOM uint32_t ck_p_pad_ctrl;               /*!< (@ 0x00000334) CK P Pad Control Register                                  */
  ...
  union {
    __IOM uint32_t ck_p_pad_ctrl1;              /*!< (@ 0x00000338) CK P Pad Control Register 1                                */
  ...
  union {
    __IOM uint32_t ck_n_pad_ctrl;               /*!< (@ 0x0000033C) CK N Pad Control Register                                  */
  ...
  union {
    __IOM uint32_t ck_n_pad_ctrl1;              /*!< (@ 0x00000340) CK N Pad Control Register 1                                */
  ...
  union {
    __IOM uint32_t cmd_pad_ctrl;                /*!< (@ 0x00000344) CMD Pad Control Register                                   */
  ...
  union {
    __IOM uint32_t cs_pad_ctrl;                 /*!< (@ 0x00000348) CS Pad Control Register                                    */
