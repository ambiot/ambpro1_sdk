/**************************************************************************//**
 * @file     partition_rtl8195bhp.h
 * @brief    CMSIS-CORE Initial Setup for Secure / Non-Secure Zones for rtl8195b-hp
 * @version  1.00
 * @date     2016-07-20
 *
 ******************************************************************************
...
#ifndef _PARTITION_RTL8195BH_H_
#define _PARTITION_RTL8195BH_H_
...
*/
#define SAU_INIT_END0       0x1007DFFF      /* end address of SAU region 0 */
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START1     0x20008000

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END1       0x20113FFF
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START3     0x20114000

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END3       0x20119FFF
...
*/
#define NVIC_INIT_ITNS0_MASK        ((1<<TimerGroup0_IRQn)|(1<<ICC_IRQn)|(1<<SGDMA0_IRQn)|\
                                     (1<<SGDMA1_IRQn)|(1<<SCrypto_IRQn)|(1<<SLowPri_IRQn))
