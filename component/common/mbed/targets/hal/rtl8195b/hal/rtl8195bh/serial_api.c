...
static const PinMap PinMap_UART_RX[] = {
    {PE_4,  RTL_PIN_PERI(PID_UART0, 0, PinSel0), RTL_PIN_FUNC(PID_UART0, PinSel0)},
    {PG_6,  RTL_PIN_PERI(PID_UART0, 0, PinSel1), RTL_PIN_FUNC(PID_UART0, PinSel1)},
    {PH_0,  RTL_PIN_PERI(PID_UART0, 0, PinSel2), RTL_PIN_FUNC(PID_UART0, PinSel2)},
    {PC_0,  RTL_PIN_PERI(PID_UART0, 0, PinSel3), RTL_PIN_FUNC(PID_UART0, PinSel3)},
    {PB_0,  RTL_PIN_PERI(PID_UART1, 1, PinSel0), RTL_PIN_FUNC(PID_UART1, PinSel0)},
    {PG_5,  RTL_PIN_PERI(PID_UART1, 1, PinSel1), RTL_PIN_FUNC(PID_UART1, PinSel1)},
    {PC_4,  RTL_PIN_PERI(PID_UART1, 1, PinSel2), RTL_PIN_FUNC(PID_UART1, PinSel2)},
    {PC_8,  RTL_PIN_PERI(PID_UART2, 2, PinSel0), RTL_PIN_FUNC(PID_UART2, PinSel0)},
    {PE_0,  RTL_PIN_PERI(PID_UART2, 2, PinSel1), RTL_PIN_FUNC(PID_UART2, PinSel1)},
    {PH_4,  RTL_PIN_PERI(PID_UART2, 2, PinSel2), RTL_PIN_FUNC(PID_UART2, PinSel2)},
    {NC,    NC,     0}
};

static const PinMap PinMap_UART_TX[] = {
    {PE_5,  RTL_PIN_PERI(PID_UART0, 0, PinSel0), RTL_PIN_FUNC(PID_UART0, PinSel0)},
    {PG_7,  RTL_PIN_PERI(PID_UART0, 0, PinSel1), RTL_PIN_FUNC(PID_UART0, PinSel1)},
    {PH_1,  RTL_PIN_PERI(PID_UART0, 0, PinSel2), RTL_PIN_FUNC(PID_UART0, PinSel2)},
    {PC_1,  RTL_PIN_PERI(PID_UART0, 0, PinSel3), RTL_PIN_FUNC(PID_UART0, PinSel3)},
    {PB_1,  RTL_PIN_PERI(PID_UART1, 1, PinSel0), RTL_PIN_FUNC(PID_UART1, PinSel0)},
    {PG_4,  RTL_PIN_PERI(PID_UART1, 1, PinSel1), RTL_PIN_FUNC(PID_UART1, PinSel1)},
    {PC_5,  RTL_PIN_PERI(PID_UART1, 1, PinSel2), RTL_PIN_FUNC(PID_UART1, PinSel2)},
    {PC_9,  RTL_PIN_PERI(PID_UART2, 2, PinSel0), RTL_PIN_FUNC(PID_UART2, PinSel0)},
    {PE_1,  RTL_PIN_PERI(PID_UART2, 2, PinSel1), RTL_PIN_FUNC(PID_UART2, PinSel1)},
    {PH_5,  RTL_PIN_PERI(PID_UART2, 2, PinSel2), RTL_PIN_FUNC(PID_UART2, PinSel2)},
    {NC,    NC,     0}
};
...
void serial_init(serial_t *obj, PinName tx, PinName rx)
{
    ...
    if (unlikely(uart_sel == (uint8_t)NC)) {
        DBG_UART_ERR("serial_init: Cannot find matched UART\n");
        return;
    }

    ret = hal_uart_init (&obj->uart_adp, RTL_GET_PERI_IDX(uart_sel), (uint8_t)RTL_GET_PERI_SEL(uart_sel), NULL);
...
static void _serial_tx_irq_handler(uint32_t id, SerialIrq event)
{
    ...
    if (obj->uart_adp.base_addr->ier_b.etbei == 0) {
