...
static const PinMap PinMap_PWM[] = {
    {PE_0,  RTL_PIN_PERI(PID_PWM0, 0, PinSel0), RTL_PIN_FUNC(PID_PWM0, PinSel0)},
    {PE_1,  RTL_PIN_PERI(PID_PWM1, 1, PinSel0), RTL_PIN_FUNC(PID_PWM1, PinSel0)},
    {PE_2,  RTL_PIN_PERI(PID_PWM2, 2, PinSel0), RTL_PIN_FUNC(PID_PWM2, PinSel0)},
    {PE_3,  RTL_PIN_PERI(PID_PWM3, 3, PinSel0), RTL_PIN_FUNC(PID_PWM3, PinSel0)},
    {PE_4,  RTL_PIN_PERI(PID_PWM4, 4, PinSel0), RTL_PIN_FUNC(PID_PWM4, PinSel0)},
    {PE_5,  RTL_PIN_PERI(PID_PWM5, 5, PinSel0), RTL_PIN_FUNC(PID_PWM5, PinSel0)},
    {PE_6,  RTL_PIN_PERI(PID_PWM6, 6, PinSel0), RTL_PIN_FUNC(PID_PWM6, PinSel0)},
    {PE_7,  RTL_PIN_PERI(PID_PWM7, 7, PinSel0), RTL_PIN_FUNC(PID_PWM7, PinSel0)},

    {PG_2,  RTL_PIN_PERI(PID_PWM0, 0, PinSel1), RTL_PIN_FUNC(PID_PWM0, PinSel1)},
    {PG_3,  RTL_PIN_PERI(PID_PWM1, 1, PinSel1), RTL_PIN_FUNC(PID_PWM1, PinSel1)},
    {PG_4,  RTL_PIN_PERI(PID_PWM2, 2, PinSel1), RTL_PIN_FUNC(PID_PWM2, PinSel1)},
    {PG_5,  RTL_PIN_PERI(PID_PWM3, 3, PinSel1), RTL_PIN_FUNC(PID_PWM3, PinSel1)},
    {PG_6,  RTL_PIN_PERI(PID_PWM4, 4, PinSel1), RTL_PIN_FUNC(PID_PWM4, PinSel1)},
    {PG_7,  RTL_PIN_PERI(PID_PWM5, 5, PinSel1), RTL_PIN_FUNC(PID_PWM5, PinSel1)},
    {PG_8,  RTL_PIN_PERI(PID_PWM6, 6, PinSel1), RTL_PIN_FUNC(PID_PWM6, PinSel1)},
    {PG_9,  RTL_PIN_PERI(PID_PWM7, 7, PinSel1), RTL_PIN_FUNC(PID_PWM7, PinSel1)},

    {PC_4,  RTL_PIN_PERI(PID_PWM0, 0, PinSel2), RTL_PIN_FUNC(PID_PWM0, PinSel2)},
    {PC_5,  RTL_PIN_PERI(PID_PWM1, 1, PinSel2), RTL_PIN_FUNC(PID_PWM1, PinSel2)},
    {PC_6,  RTL_PIN_PERI(PID_PWM2, 2, PinSel2), RTL_PIN_FUNC(PID_PWM2, PinSel2)},
    {PC_7,  RTL_PIN_PERI(PID_PWM3, 3, PinSel2), RTL_PIN_FUNC(PID_PWM3, PinSel2)},
    {PC_8,  RTL_PIN_PERI(PID_PWM4, 4, PinSel2), RTL_PIN_FUNC(PID_PWM4, PinSel2)},
    {PC_9,  RTL_PIN_PERI(PID_PWM5, 5, PinSel2), RTL_PIN_FUNC(PID_PWM5, PinSel2)},
    {PC_10, RTL_PIN_PERI(PID_PWM6, 6, PinSel2), RTL_PIN_FUNC(PID_PWM6, PinSel2)},
    {PC_11, RTL_PIN_PERI(PID_PWM7, 7, PinSel2), RTL_PIN_FUNC(PID_PWM7, PinSel2)},

    {PB_0,  RTL_PIN_PERI(PID_PWM0, 0, PinSel3), RTL_PIN_FUNC(PID_PWM0, PinSel3)},
    {PB_1,  RTL_PIN_PERI(PID_PWM1, 1, PinSel3), RTL_PIN_FUNC(PID_PWM1, PinSel3)},
    {PB_2,  RTL_PIN_PERI(PID_PWM2, 2, PinSel3), RTL_PIN_FUNC(PID_PWM2, PinSel3)},
    {PB_3,  RTL_PIN_PERI(PID_PWM3, 3, PinSel3), RTL_PIN_FUNC(PID_PWM3, PinSel3)},
    {PB_4,  RTL_PIN_PERI(PID_PWM4, 4, PinSel3), RTL_PIN_FUNC(PID_PWM4, PinSel3)},
    {PB_5,  RTL_PIN_PERI(PID_PWM5, 5, PinSel3), RTL_PIN_FUNC(PID_PWM5, PinSel3)},
    {PB_6,  RTL_PIN_PERI(PID_PWM6, 6, PinSel3), RTL_PIN_FUNC(PID_PWM6, PinSel3)},
    {PB_7,  RTL_PIN_PERI(PID_PWM7, 7, PinSel3), RTL_PIN_FUNC(PID_PWM7, PinSel3)},
...
static hal_timer_group_adapter_t _timer_group1;
void pwmout_init(pwmout_t *obj, PinName pin)
{
    ...
    if (!pwm_com_initialed) {
        hal_timer_group_init (&_timer_group1, 1); // Initialize timer group 1 for PWM module
        hal_timer_group_sclk_sel (&_timer_group1, 2000000); // Default 2MHz
    ...
    if (hal_pwm_init (&obj->pwm_hal_adp, pwm_idx, pin_sel, duty_res) != HAL_OK) {
