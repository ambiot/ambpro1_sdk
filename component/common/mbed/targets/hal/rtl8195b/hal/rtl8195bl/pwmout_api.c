...
static const PinMap PinMap_PWM[] = {
    ...
    {PA_7,  RTL_PIN_PERI(PID_PWM0, 0, PinSel1), RTL_PIN_FUNC(PID_PWM0, PinSel1)},
    {PA_8,  RTL_PIN_PERI(PID_PWM1, 1, PinSel1), RTL_PIN_FUNC(PID_PWM1, PinSel1)},
    {PA_9,  RTL_PIN_PERI(PID_PWM2, 2, PinSel1), RTL_PIN_FUNC(PID_PWM2, PinSel1)},
    {PA_10, RTL_PIN_PERI(PID_PWM3, 3, PinSel1), RTL_PIN_FUNC(PID_PWM3, PinSel1)},
