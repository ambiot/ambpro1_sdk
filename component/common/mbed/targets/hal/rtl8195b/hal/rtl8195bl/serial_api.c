...
static const PinMap PinMap_UART_TX[] = {
    {PA_8,  RTL_PIN_PERI(PID_UART0, 0, PinSel0), RTL_PIN_FUNC(PID_UART0, PinSel0)},
    {PA_1,  RTL_PIN_PERI(PID_UART1, 1, PinSel0), RTL_PIN_FUNC(PID_UART1, PinSel0)},
    {NC,    NC,     0}
};

static const PinMap PinMap_UART_RX[] = {
    {PA_7,  RTL_PIN_PERI(PID_UART0, 0, PinSel0), RTL_PIN_FUNC(PID_UART0, PinSel0)},
    {PA_0,  RTL_PIN_PERI(PID_UART1, 1, PinSel0), RTL_PIN_FUNC(PID_UART1, PinSel0)},
    {NC,    NC,     0}
};
...
static uint8_t serial_dma_init[UART_NUM] = {0, 0};
#endif
...
int32_t serial_recv_blocked (serial_t *obj, char *prxbuf, uint32_t len, uint32_t timeout_ms)
{
    ...
    if (obj->uart_adp.rx_status != HAL_UART_STATUS_OK) {
        DBG_UART_WARN ("%s: status(%d)\n", __func__, obj->uart_adp.rx_status);
    }
...
int32_t serial_send_blocked (serial_t *obj, char *ptxbuf, uint32_t len, uint32_t timeout_ms)
{
    ...
    if (obj->uart_adp.tx_status != HAL_UART_STATUS_OK) {
        DBG_UART_WARN ("%s: status(%d)\n", __func__, obj->uart_adp.tx_status);
    }
