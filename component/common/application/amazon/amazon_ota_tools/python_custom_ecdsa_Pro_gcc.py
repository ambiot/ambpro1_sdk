...
fw_bin = open('../../../../../project/realtek_amebapro_v0_example/GCC-RELEASE/application_is/firmware_is.bin', 'br').read()
fw_bin_size = os.path.getsize("../../../../../project/realtek_amebapro_v0_example/GCC-RELEASE/application_is/firmware_is.bin")
...
f = open("../../../../../project/realtek_amebapro_v0_example/GCC-RELEASE/application_is/firmware_is_pad.bin", 'wb')
f.write(fw_bin)
f.write(x)
f.close()

#Reading OTA1 binary and individually signing it using the ECDSA P256 curve
ota1_bin = open('../../../../../project/realtek_amebapro_v0_example/GCC-RELEASE/application_is/firmware_is_pad.bin', 'br').read()
ota1_bin_size = os.path.getsize("../../../../../project/realtek_amebapro_v0_example/GCC-RELEASE/application_is/firmware_is_pad.bin")
...
#os.remove('../../../../../project/realtek_amebapro_v0_example/GCC-RELEASE/application_is/firmware_is_pad.bin')
