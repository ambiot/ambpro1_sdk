...
#if (MBEDTLS_VERSION_NUMBER==0x02100300|| MBEDTLS_VERSION_NUMBER==0x02100600) //if version number equals 2.16.4
...
{
    if(rom_ssl_ram_map.use_hw_crypto_func && rom_ssl_ram_map.hw_crypto_aes_cbc_init )
    {
        switch(keybits)
        {
...
int mbedtls_aes_crypt_ecb( mbedtls_aes_context *ctx,
                    ...
                    unsigned char output[16] )
{
    if(rom_ssl_ram_map.use_hw_crypto_func && rom_ssl_ram_map.hw_crypto_aes_ecb_init)
    {
